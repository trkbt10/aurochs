...
import { renderSlideSvgIntegrated } from "../../app/slide-render";
import { createSlideContext, type SlideContext } from "../../parser/slide/context";
 ...
 * @example
 * ```typescript
 * import { renderSlideToSvg } from "../pptx/render/svg";
 *
