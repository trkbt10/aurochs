...
import type { PdfBBox, PdfMatrix, PdfPoint } from "@aurochs/pdf/domain";
...
function convertPointToNumbers(point: PdfPoint, context: ConversionContext): PptxPoint {
 ...
 * PDF座標をPPTX座標に変換
 */
export function convertPoint(point: PdfPoint, context: ConversionContext): { readonly x: Pixels; readonly y: Pixels } {
