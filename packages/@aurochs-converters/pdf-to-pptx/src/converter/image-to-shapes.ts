...
import type { PdfColorSpace, PdfImage } from "@aurochs/pdf/domain";
import type { PicShape, BlipFillProperties } from "@aurochs-office/pptx/domain/shape";
...
import type { PdfBBox, PdfMatrix, PdfSoftMask } from "@aurochs/pdf/domain";
import {
  clamp01,
  cmykToRgb,
  grayToRgb,
 ...
 */
export function convertImageToShape(image: PdfImage, context: ConversionContext, shapeId: string): PicShape | null {
  if (shapeId.length === 0) {
...
function toMatteRgbBytes(
  matte: readonly number[],
