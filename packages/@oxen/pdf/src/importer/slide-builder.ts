...
import type { Slide, Background } from "@oxen/pptx/domain/slide/types";
import type { SpShape } from "@oxen/pptx/domain/shape";
import type { SlideId, SlideWithId } from "@oxen/pptx/app/presentation-document";
import type { Pixels } from "@oxen/ooxml/domain/units";
import { deg, pt, px } from "@oxen/ooxml/domain/units";
