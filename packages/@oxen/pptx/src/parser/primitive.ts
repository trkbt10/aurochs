...
import type { Degrees, Percent, Pixels, Points } from "@oxen/ooxml/domain/units";
import type { SchemeColorValue } from "@oxen/ooxml/domain/color";
import type { BlipCompression } from "@oxen/ooxml/domain/drawing";
