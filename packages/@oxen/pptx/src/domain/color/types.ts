...
import type { Brand, Degrees, Percent, Pixels } from "@oxen/ooxml/domain/units";
import type { BlipCompression, TileFlipMode } from "@oxen/ooxml/domain/drawing";
