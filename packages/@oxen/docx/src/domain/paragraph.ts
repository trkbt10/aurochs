...
import type { ParagraphAlignment, TabStopAlignment, TabStopLeader } from "@oxen/ooxml/domain/text";
import type { WordBorderStyle, EighthPoints } from "@oxen/ooxml/domain/border";
