...
import type { Scene3d, Shape3d, LightRig, Bevel3d } from "@aurochs-office/pptx/domain";
...
describe("effects3d - ECMA-376 compliance", () => {
  ...
  describe("renderExtrusionEffect (ECMA-376 20.1.5.9)", () => {
    ...
    it("adjusts offset based on camera preset", () => {
      const obliqueResult = renderExtrusionEffect({
        shapePath: testPath,
        extrusionHeight: 20,
        extrusionColor: "#666666",
        camera: "obliqueTopRight",
      });
      const frontResult = renderExtrusionEffect({
        shapePath: testPath,
        extrusionHeight: 20,
        extrusionColor: "#666666",
