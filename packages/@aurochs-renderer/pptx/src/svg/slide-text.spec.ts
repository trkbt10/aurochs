...
import type { Paragraph, RunProperties, TextBody } from "@aurochs-office/pptx/domain/text";
...
describe("renderTextSvg", () => {
  it("uses a font-family fallback list for font substitution", () => {
    ...
    expect(svg).toContain('font-family="LatinFont, EastAsianFont, ComplexFont, SymbolFont"');
  });
});
