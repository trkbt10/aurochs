...
import { createGuideContext, evaluateGuides } from "@aurochs-office/pptx/domain/shape-geometry/guide-engine";
 ...
 */
function scaleCommand(command: PathCommand, scaleX: number, scaleY: number): PathCommand {
  switch (command.type) {
    case "moveTo":
      return {
        type: "moveTo",
