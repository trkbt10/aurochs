...
import type { TextAlign, TextAnchor } from "@aurochs-office/pptx/domain/types";
import type {
  LineSpacing,
  TextWrapping,
  TextOverflow,
...
import type { TextEffectsConfig } from "@aurochs-office/drawing-ml/domain/text-effects";
