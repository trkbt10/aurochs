 ...
 */
function buildTransition(properties: string[], duration: number, easing: string = "ease-out"): string {
 ...
 */
export function applyFade(el: HTMLElement | SVGElement, config: EffectConfig): void {
 ...
 */
export function applySlide(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "left", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyWipe(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "right", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyBlinds(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "horizontal", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyBox(el: HTMLElement | SVGElement, config: EffectConfig): void {
 ...
 */
export function applyCheckerboard(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "across", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyCircle(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "in", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyDiamond(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "in", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyDissolve(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyStrips(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "downRight", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyWheel(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, entrance = true, easing = "ease-out" } = config;

  el.style.transition = buildTransition(["transform", "opacity", "clip-path"], duration, easing);
 ...
 */
export function applyPlus(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "in", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyBarn(el: HTMLElement | SVGElement, config: EffectConfig): void {
 ...
 */
export function applyRandombar(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, direction = "horizontal", entrance = true, easing = "ease-out" } = config;
 ...
 */
export function applyWedge(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const { duration, entrance = true, easing = "ease-out" } = config;
 ...
 * @see MS-OE376 Part 4 Section 4.6.3
 */
export function applyEffect(el: HTMLElement | SVGElement, config: EffectConfig): void {
  const effectMap: Record<EffectType, (el: HTMLElement | SVGElement, config: EffectConfig) => void> = {
    fade: applyFade,
    slide: applySlide,
    wipe: applyWipe,
    blinds: applyBlinds,
