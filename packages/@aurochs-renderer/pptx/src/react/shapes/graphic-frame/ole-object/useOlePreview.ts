...
export function useOlePreview(oleData: OleReference | undefined): OlePreviewResult {
  ...
  return useMemo(() => {
    ...
    const imageWidth = oleData.imgW !== undefined ? oleData.imgW / EMU_PER_PIXEL : undefined;
    const imageHeight = oleData.imgH !== undefined ? oleData.imgH / EMU_PER_PIXEL : undefined;
