...
describe("GraphicFrameRenderer", () => {
  describe("table content", () => {
    it("renders table without throwing when colorContext is provided", () => {
      ...
      expect(() => {
        render(
          <TestWrapper>
            <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-table" />
          </TestWrapper>,
        );
      }).not.toThrow();
    });
  ...
  describe("unknown content", () => {
    it("renders placeholder for unknown content", () => {
      ...
      const { container } = render(
        <TestWrapper>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-unknown" />
        </TestWrapper>,
      );
  ...
  describe("chart content", () => {
    it("renders placeholder when parsedChart is missing", () => {
      ...
      const { container } = render(
        <TestWrapper>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-chart" />
        </TestWrapper>,
      );
  ...
  describe("OLE object content", () => {
    it("renders placeholder when preview is missing", () => {
      ...
      const { container } = render(
        <TestWrapper>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-ole" />
        </TestWrapper>,
      );
    ...
    it("renders image when preview is available in ResourceStore", () => {
      ...
      const redPixelPng =
        "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8DwHwAFBQIAXxPhfQAAAABJRU5ErkJggg==";
      ...
      const { container } = render(
        <TestWrapper resourceStore={resourceStore}>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-ole-preview" />
        </TestWrapper>,
      );
    ...
    it("renders icon view when showAsIcon is true", () => {
      ...
      const { container } = render(
        <TestWrapper>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-ole-icon" />
        </TestWrapper>,
      );
  ...
  describe("transform handling", () => {
    it("applies transform when provided", () => {
      ...
      const { container } = render(
        <TestWrapper>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-transform" />
        </TestWrapper>,
      );
    ...
    it("handles zero rotation transform", () => {
      ...
      const { container } = render(
        <TestWrapper>
          <GraphicFrameRenderer shape={shape} width={200} height={100} shapeId="test-no-rotation" />
        </TestWrapper>,
      );
