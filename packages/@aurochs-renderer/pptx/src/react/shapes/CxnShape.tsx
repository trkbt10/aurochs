...
import type { CxnShape as CxnShapeType } from "@aurochs-office/pptx/domain";
 ...
 */
export function CxnShapeRenderer({ shape, width, height, shapeId }: CxnShapeRendererProps) {
  ...
  return (
    <g transform={transformValue || undefined} data-shape-id={shapeId} data-shape-type="cxnSp">
