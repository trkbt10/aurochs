...
function getNextTabStop(currentX: number, paragraph: TextMeasureParagraph): number {
...
function measureBulletWidth(textNode: SVGTextElement, paragraph: TextMeasureParagraph): number | undefined {
