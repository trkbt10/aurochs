...
import { px, pt, deg } from "@aurochs-office/drawing-ml/domain/units";
...
import { convertTextToShape, createFitContext } from "@aurochs-converters/pdf-to-pptx/converter";
...
function createTextShape(fontFamily: string, fontFamilyEastAsian?: string, fontFamilyComplexScript?: string): SpShape {
  return {
    type: "sp",
