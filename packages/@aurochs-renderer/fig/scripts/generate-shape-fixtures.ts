 ...
 *
 * Usage:
 *   bun packages/@aurochs-renderer/fig/scripts/generate-shape-fixtures.ts
 */
...
async function generateShapeFixtures(): Promise<void> {
  ...
  console.log(`4. Run: npx vitest run packages/@aurochs-renderer/fig/spec/shapes.spec.ts`);
}
