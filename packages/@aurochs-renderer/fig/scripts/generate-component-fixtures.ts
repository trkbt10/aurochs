 ...
 *
 * Usage:
 *   bun packages/@aurochs-renderer/fig/scripts/generate-component-fixtures.ts
 */
...
async function generateComponentFixtures(): Promise<void> {
  ...
  console.log(`4. Run: npx vitest run packages/@aurochs-renderer/fig/spec/components.spec.ts`);
}
