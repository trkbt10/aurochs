 ...
 *
 * Usage: bun packages/@aurochs-renderer/fig/scripts/generate-layout-fixtures.ts
 */
...
const TEMPLATE_FILE = path.join(import.meta.dir, "../../../@aurochs/fig/samples/sample-file.fig");
