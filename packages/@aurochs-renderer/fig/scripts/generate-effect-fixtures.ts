 ...
 *
 * Usage:
 *   bun packages/@aurochs-renderer/fig/scripts/generate-effect-fixtures.ts
 */
...
async function generateEffectFixtures(): Promise<void> {
  ...
  console.log(`3. Run: npx vitest run packages/@aurochs-renderer/fig/spec/effects.spec.ts`);
}
