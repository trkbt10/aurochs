 ...
 */
function extractPageBreakHints(paragraphs: readonly DocxParagraph[]): readonly (PageBreakHint | undefined)[] {
 ...
 */
export function haveParagraphsChanged(prev: readonly DocxParagraph[], next: readonly DocxParagraph[]): boolean {
