 ...
 * (DrawingML Diagrams) visual regression tests within @aurochs-renderer/diagram.
 *
 ...
 */
export type DiagramType = "list" | "process" | "cycle" | "hierarchy" | "relationship" | "matrix" | "pyramid" | "custom";
