 ...
 *
 * Run:
 *   npx vitest run packages/@aurochs-renderer/figma/spec/webgl-effects.spec.ts
 */
...
const CATEGORIES: Record<string, string[]> = {
  "drop-shadow": ["shadow-drop-basic", "shadow-drop-offset", "shadow-drop-color", "shadow-drop-multi"],
