 ...
 *
 * Run:
 *   npx vitest run packages/@aurochs-renderer/figma/spec/webgl-text.spec.ts
 */
...
const CATEGORIES: Record<string, string[]> = {
  ...
  multiline: ["2-lines", "3-lines", "5-lines", "empty-lines", "long-word", "wrap-narrow"],
  "edge-cases": ["empty", "space-only", "single-char", "unicode-cjk", "unicode-emoji", "unicode-arabic"],
  "case-variants": ["case-LOWER", "case-ORIGINAL", "case-SMALL_CAPS", "case-TITLE", "case-UPPER"],
  decorations: [
    "UNDERLINE-12px",
    "UNDERLINE-16px",
    "UNDERLINE-24px",
  ...
  constraints: ["WIDTH_AND_HEIGHT-long", "WIDTH_AND_HEIGHT-short"],
  misc: ["mixed", "numbers", "special"],
};
