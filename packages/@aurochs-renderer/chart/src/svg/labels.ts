...
import type { DataLabels, ChartShapeProperties } from "@aurochs-office/chart/domain";
...
export function renderDataLabels({
  ...
  if (!dataLabels.showVal && !dataLabels.showCatName && !dataLabels.showSerName && !dataLabels.showPercent) {
    return "";
  }
