...
import type { ErrorBars } from "@aurochs-office/chart/domain";
...
describe("Error Bars Rendering (ECMA-376 21.2.2.58)", () => {
  ...
  describe("renderAllErrorBars helper", () => {
    test("returns empty string for undefined error bars", () => {
      const svg = renderAllErrorBars({
        errorBarsArray: undefined,
        seriesData: mockSeriesData,
        chartWidth: mockChartWidth,
        chartHeight: mockChartHeight,
        valueRange: mockValueRange,
