...
import type { ErrorBars, ChartShapeProperties, DataReference } from "@aurochs-office/chart/domain";
 ...
 * @see ECMA-376 Part 1, Section 21.2.3.19 (ST_ErrValType)
 */
function calculateErrorValues(errorBars: ErrorBars, seriesData: SeriesData): { plus: number[]; minus: number[] } {
...
export function renderErrorBars({
  ...
  const style = getErrorBarStyle(errorBars.shapeProperties, fillResolver);
