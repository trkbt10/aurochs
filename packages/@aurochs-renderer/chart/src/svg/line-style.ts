...
import type { ChartLines, ChartShapeProperties } from "@aurochs-office/chart/domain";
 ...
 * @see ECMA-376 Part 1, Section 20.1.2.2.24 (a:ln)
 */
export function extractLineStyle(
 ...
 */
export function extractDropLineStyle(
  chartLines: ChartLines | undefined,
  fillResolver: FillResolver,
): ResolvedLineStyle {
 ...
 */
export function extractHiLowLineStyle(
  chartLines: ChartLines | undefined,
  fillResolver: FillResolver,
): ResolvedLineStyle {
  if (!chartLines?.shapeProperties) {
