...
import { ColorSwatch, ColorSwatchRow } from "@aurochs-renderer/drawing-ml/react";
...
export function ColorTest() {
  ...
  return (
    <div className="test-section">
      <h3>Color System</h3>
      <p className="section-description">ECMA-376 color specifications and transforms.</p>
      ...
      <TestSubsection title="Color Scheme (12 slots)" items={[{ label: "Full scheme support", status: "pass" }]}>
