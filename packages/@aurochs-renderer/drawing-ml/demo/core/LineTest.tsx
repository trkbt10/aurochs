...
export function LineTest() {
  ...
  return (
    <div className="test-section">
      ...
      <p className="section-description">ECMA-376 Section 20.1.8.36 - Line properties (a:ln).</p>
      ...
      <TestSubsection title="Stroke Color" items={[{ label: "Solid stroke color", status: "pass" }]}>
        <div className="shape-row">
          <LinePreview
            line={baseLine({
