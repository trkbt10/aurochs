...
export function EffectsTest() {
  ...
  return (
    <div className="test-section">
      <h3>Effects</h3>
      <p className="section-description">ECMA-376 Section 20.1.8 - Effect containers and filter rendering.</p>
      ...
      <TestSubsection title="Combined Effects" items={[{ label: "Multiple effects", status: "pass" }]}>
        <div className="effects-row">
          <EffectPreview
            effects={{
              shadow: {
