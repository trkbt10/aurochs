 ...
 */
function ColorSwatchDisplay({ resolved, size, showInfo, showTransparency, className }: ColorSwatchDisplayProps) {
  ...
  return (
    ...
    >
      ...
      >
        <defs>{showTransparency && hasTransparency && <CheckerboardPattern id={patternId} />}</defs>

        {/* Checkerboard background for transparency */}
        {showTransparency && hasTransparency && <rect width={size} height={size} fill={`url(#${patternId})`} />}

        {/* Color fill */}
        <rect width={size} height={size} fill={resolved.cssColor} fillOpacity={resolved.alpha} />
