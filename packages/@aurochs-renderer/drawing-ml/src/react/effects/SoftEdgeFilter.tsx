...
import type { SoftEdgeEffect } from "@aurochs-office/drawing-ml/domain/effects";
 ...
 * ```
 */
export const SoftEdgeFilterDef = memo(function SoftEdgeFilterDef({ id, softEdge }: SoftEdgeFilterDefProps): ReactNode {
