...
import type { GlowEffect } from "@aurochs-office/drawing-ml/domain/effects";
 ...
 */
export function resolveGlowProps(glow: GlowEffect, colorContext: ColorContext): ResolvedGlowProps | null {
  // Resolve glow color
