...
import type { ShadowEffect } from "@aurochs-office/drawing-ml/domain/effects";
 ...
 */
export function directionToOffset(direction: number, distance: number): { dx: number; dy: number } {
 ...
 */
export function resolveShadowProps(shadow: ShadowEffect, colorContext: ColorContext): ResolvedShadowProps | null {
...
function resolveShadowAlignment(alignment: string, validAlignments: readonly ShadowAlignment[]): ShadowAlignment {
