 ...
 */
function renderDiagonal(direction: "up" | "down", spacing: number, lineWidth: number): PatternGeometry["render"] {
  return (fg) => (
    <line
      x1="0"
...
function renderHorizontal(spacing: number, lineWidth: number): PatternGeometry["render"] {
  return (fg) => <line x1="0" y1="0" x2={spacing} y2="0" stroke={`#${fg}`} strokeWidth={lineWidth} />;
}
...
function renderVertical(spacing: number, lineWidth: number): PatternGeometry["render"] {
  return (fg) => <line x1="0" y1="0" x2="0" y2={spacing} stroke={`#${fg}`} strokeWidth={lineWidth} />;
}
 ...
 */
function renderPercentDots(dotRadius: number, spacing: number): PatternGeometry["render"] {
  return (fg) => <circle cx={spacing / 2} cy={spacing / 2} r={dotRadius} fill={`#${fg}`} />;
}
 ...
 * ```
 */
export const PatternDef = memo(function PatternDef({ id, preset, fgColor, bgColor }: PatternDefProps) {
