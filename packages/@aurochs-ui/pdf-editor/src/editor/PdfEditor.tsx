...
import { pdfTextAdapter } from "../modules/formatting-context/pdf-text-adapter";
...
import { PdfPropertyPanel } from "./components/PdfPropertyPanel";
import { PdfPageListPanel } from "./components/PdfPageListPanel";
