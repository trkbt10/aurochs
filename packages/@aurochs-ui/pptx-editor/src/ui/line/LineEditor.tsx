...
function LineEndEditor({ value, onChange, label, disabled }: LineEndEditorProps) {
  ...
  return (
    <div style={lineEndFieldStyle}>
      ...
      <Select value={lineEnd.type} onChange={handleTypeChange} options={lineEndTypeOptions} disabled={disabled} />
      {lineEnd.type !== "none" && (
  ...
  return (
    <div style={{ ...containerStyle, ...style }} className={className}>
      ...
      <div style={sectionStyle}>
        ...
        <FillPickerPopover value={value.fill as BaseFill} onChange={handleFillChange} disabled={disabled} />
      </div>
