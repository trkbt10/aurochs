 ...
 */
function splitTextRunAtSelection(args: {
 ...
 */
function applyFormatToRun(args: {
 ...
 */
function applyFormatToParagraphRuns(args: {
 ...
 */
function processParagraphForFormat(args: {
  readonly paragraph: Paragraph;
  ...
  const selStartInPara = paragraphIndex === start.paragraphIndex ? start.charOffset : 0;

  const selEndInPara = paragraphIndex === end.paragraphIndex ? end.charOffset : paragraphLength;
 ...
 */
export function toggleRunProperty(args: {
  readonly textBody: TextBody;
  readonly selection: TextSelection;
