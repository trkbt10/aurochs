 ...
 */
export function isTextEditInactive(state: TextEditState): state is InactiveTextEditState {
 ...
 */
export function isTextEditActive(state: TextEditState): state is ActiveTextEditState {
 ...
 */
export function createActiveStickyFormatting(runProperties: RunProperties): StickyFormattingState {
  return {
    runProperties,
    active: true,
  };
 ...
 */
export function deactivateStickyFormatting(state: StickyFormattingState): StickyFormattingState {
  return {
    ...state,
    active: false,
  };
