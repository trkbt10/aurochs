...
describe("mergeAdjacentRuns", () => {
  it("merges adjacent text runs with same properties", () => {
    const runs: TextRun[] = [createTextRun("Hello", { bold: true }), createTextRun(" World", { bold: true })];
  ...
  it("does not merge runs with different properties", () => {
    const runs: TextRun[] = [createTextRun("Hello", { bold: true }), createTextRun(" World", { italic: true })];
  ...
  it("does not merge break runs", () => {
    const runs: TextRun[] = [createTextRun("Hello"), { type: "break" as const }, createTextRun("World")];
  ...
  it("merges runs with undefined properties", () => {
    const runs: TextRun[] = [createTextRun("Hello"), createTextRun(" World")];
...
describe("applyRunPropertiesToSelection", () => {
  it("applies formatting to entire single run", () => {
    const textBody = createTextBody([createParagraph([createTextRun("Hello World")])]);
  ...
  it("applies formatting across multiple runs", () => {
    const textBody = createTextBody([
      createParagraph([createTextRun("Hello ", { italic: true }), createTextRun("World")]),
    ]);
  ...
  it("merges properties with existing run properties", () => {
    const textBody = createTextBody([createParagraph([createTextRun("Hello", { italic: true })])]);
  ...
  it("returns unchanged textBody for empty selection", () => {
    const textBody = createTextBody([createParagraph([createTextRun("Hello")])]);
  ...
  it("merges adjacent runs after applying same formatting", () => {
    const textBody = createTextBody([
      createParagraph([createTextRun("Hello", { bold: true }), createTextRun(" World")]),
    ]);
...
describe("normalizeTextBody", () => {
  it("merges adjacent runs in all paragraphs", () => {
    const textBody = createTextBody([
      createParagraph([createTextRun("A", { bold: true }), createTextRun("B", { bold: true })]),
      createParagraph([createTextRun("C"), createTextRun("D")]),
    ]);
...
describe("toggleRunProperty", () => {
  ...
  it("turns off property when currently on", () => {
    const textBody = createTextBody([createParagraph([createTextRun("Hello", { bold: true })])]);
...
describe("edge cases", () => {
  it("handles break runs correctly", () => {
    const textBody = createTextBody([
      createParagraph([createTextRun("Hello"), { type: "break" as const }, createTextRun("World")]),
    ]);
