...
function areRectsEqual(left: CursorState["selectionRects"], right: CursorState["selectionRects"]): boolean {
...
function areCursorCoordsEqual(left: CursorState["cursor"], right: CursorState["cursor"]): boolean {
  if (left === right) {
    return true;
  }
  if (!left || !right) {
...
function areSelectionsEqual(left: TextSelection | undefined, right: TextSelection | undefined): boolean {
  if (left === right) {
    return true;
  }
  if (!left || !right) {
