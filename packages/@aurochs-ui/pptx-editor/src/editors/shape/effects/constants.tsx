...
} from "@aurochs-office/pptx/domain/types";
...
const presetShadowOptions: SelectOption<PresetShadowValue>[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  return (
    <>
      <FieldRow>
        ...
        <FieldGroup label="Alignment" style={fieldStyle}>
          <Select
            ...
            onChange={(alignment) => onChange({ ...value, alignment: alignment === "ctr" ? undefined : alignment })}
      ...
      <FieldGroup label="Color">
        <ColorEditor value={value.color} onChange={(color) => onChange({ ...value, color })} disabled={disabled} />
      </FieldGroup>
...
function AlphaModFixEditor({
  ...
  return (
    <FieldGroup label="Amount">
      <PercentEditor value={value.amount} onChange={(amount) => onChange({ ...value, amount })} disabled={disabled} />
    </FieldGroup>
  );
}
...
function AlphaOutsetEditor({
  ...
  return (
    <FieldGroup label="Radius">
      <PixelsEditor value={value.radius} onChange={(radius) => onChange({ ...value, radius })} disabled={disabled} />
    </FieldGroup>
  );
}
...
function AlphaReplEditor({
  ...
  return (
    <FieldGroup label="Alpha">
      <PercentEditor value={value.alpha} onChange={(alpha) => onChange({ ...value, alpha })} disabled={disabled} />
    </FieldGroup>
  );
}
...
function EffectContainerEditor({
  ...
  return (
    <>
      <Toggle checked={!!value} onChange={handleToggle} label="Enable Container" disabled={disabled} />
      {value && (
        <>
  ...
  return (
    <>
      <FieldGroup label="From Color">
        <ColorEditor value={value.from} onChange={(from) => onChange({ ...value, from })} disabled={disabled} />
      </FieldGroup>
      <FieldGroup label="To Color">
        <ColorEditor value={value.to} onChange={(to) => onChange({ ...value, to })} disabled={disabled} />
      </FieldGroup>
      <Toggle
...
function DuotoneEditor({
  ...
  const handleColorChange = (index: 0 | 1, color: Color) => {
    const colors: [Color, Color] = index === 0 ? [color, value.colors[1]] : [value.colors[0], color];
  ...
  return (
    <>
      <FieldGroup label="Color 1">
        <ColorEditor value={value.colors[0]} onChange={(c) => handleColorChange(0, c)} disabled={disabled} />
      </FieldGroup>
      <FieldGroup label="Color 2">
        <ColorEditor value={value.colors[1]} onChange={(c) => handleColorChange(1, c)} disabled={disabled} />
      </FieldGroup>
    </>
  );
}
...
export const EFFECT_CONFIGS: readonly EffectConfig[] = [
  ...
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <ReflectionEditor
        value={v as ReflectionEffect}
        onChange={onChange as (v: ReflectionEffect) => void}
        disabled={disabled}
      />
    ),
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <SoftEdgeEditor
        value={v as SoftEdgeEffect}
        onChange={onChange as (v: SoftEdgeEffect) => void}
        disabled={disabled}
      />
    ),
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <PresetShadowEditor
        value={v as PresetShadowEffect}
        onChange={onChange as (v: PresetShadowEffect) => void}
        disabled={disabled}
      />
    ),
  },
  // Alpha Effects
  {
    ...
    render: (v, onChange, disabled) => (
      <AlphaBiLevelEditor
        value={v as AlphaBiLevelEffect}
        onChange={onChange as (v: AlphaBiLevelEffect) => void}
        disabled={disabled}
      />
    ),
  },
  ...
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <AlphaModEditor
        value={v as AlphaModulateEffect}
        onChange={onChange as (v: AlphaModulateEffect) => void}
        disabled={disabled}
      />
    ),
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <AlphaModFixEditor
        value={v as AlphaModulateFixedEffect}
        onChange={onChange as (v: AlphaModulateFixedEffect) => void}
        disabled={disabled}
      />
    ),
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <AlphaOutsetEditor
        value={v as AlphaOutsetEffect}
        onChange={onChange as (v: AlphaOutsetEffect) => void}
        disabled={disabled}
      />
    ),
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <AlphaReplEditor
        value={v as AlphaReplaceEffect}
        onChange={onChange as (v: AlphaReplaceEffect) => void}
        disabled={disabled}
      />
    ),
  },
  ...
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <ColorChangeEditor
        value={v as ColorChangeEffect}
        onChange={onChange as (v: ColorChangeEffect) => void}
        disabled={disabled}
      />
    ),
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <ColorReplaceEditor
        value={v as ColorReplaceEffect}
        onChange={onChange as (v: ColorReplaceEffect) => void}
        disabled={disabled}
      />
    ),
  },
  ...
  },
  {
    ...
    render: (v, onChange, disabled) => (
      <FillOverlayEditor
        value={v as FillOverlayEffect}
        onChange={onChange as (v: FillOverlayEffect) => void}
        disabled={disabled}
      />
    ),
  },
  ...
  // Transform Effects
  {
    ...
    render: (v, onChange, disabled) => (
      <RelativeOffsetEditor
        value={v as RelativeOffsetEffect}
        onChange={onChange as (v: RelativeOffsetEffect) => void}
        disabled={disabled}
      />
    ),
  },
