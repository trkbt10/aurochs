    ...
    return (
      <div style={panelStyle}>
        <div style={headerStyle}>
          <span style={{ ...titleStyle, color: "var(--text-tertiary, #737373)" }}>{selectedConfig.label}</span>
        </div>
  ...
  return (
    <div style={panelStyle}>
      ...
      <div style={contentStyle}>
        {selectedConfig.render(effectValue as NonNullable<Effects[EffectKey]>, handleEffectChange, disabled)}
      </div>
    </div>
  );
}
