...
describe("extractMixedRunProperties", () => {
  ...
  it("returns notApplicable for undefined properties", () => {
    const runs: RunProperties[] = [{ fontSize: 12 as Points }, { fontSize: 12 as Points }];
  ...
  it("handles mixed defined and undefined values", () => {
    const runs: RunProperties[] = [{ fontSize: 12 as Points, bold: true }, { fontSize: 12 as Points }];
...
describe("extractMixedParagraphProperties", () => {
  ...
  it("returns notApplicable for undefined properties", () => {
    const paras: ParagraphProperties[] = [{ alignment: "left" }, { alignment: "left" }];
