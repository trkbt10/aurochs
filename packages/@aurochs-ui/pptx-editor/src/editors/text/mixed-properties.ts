 ...
 */
export function extractCommonProperty<T>(values: readonly (T | undefined)[]): PropertyExtraction<T> {
 ...
 */
export function extractMixedRunProperties(runProperties: readonly (RunProperties | undefined)[]): MixedRunProperties {
  return {
    // Font properties
 ...
 */
export function mergeRunProperties(existing: RunProperties | undefined, update: Partial<RunProperties>): RunProperties {
  const base = existing ?? {};
 ...
 */
export function areRunPropertiesEqual(a: RunProperties | undefined, b: RunProperties | undefined): boolean {
