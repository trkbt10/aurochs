...
import { pct, deg, type Percent, type Degrees } from "@aurochs-office/drawing-ml/domain/units";
import type { ColorTransform } from "@aurochs-office/drawing-ml/domain/color";
