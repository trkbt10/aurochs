...
// getShapeTransform: import directly from "@aurochs-renderer/pptx/svg"
 ...
 */
export function getAbsoluteBounds(shape: Shape, parentGroups: readonly GrpShape[] = []): AbsoluteBounds | undefined {
