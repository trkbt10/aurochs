 ...
 */
export function isPathEditInactive(state: PathEditState): state is InactivePathEditState {
 ...
 */
export function isPathEditActive(state: PathEditState): state is ActivePathEditState {
 ...
 */
export function isPathEditMovingPoints(state: PathEditState): state is MovingPointsPathEditState {
 ...
 */
export function isPathEditMovingHandle(state: PathEditState): state is MovingHandlePathEditState {
 ...
 */
export function isPathEditEditing(state: PathEditState): state is Exclude<PathEditState, InactivePathEditState> {
  return state.type !== "inactive";
}
 ...
 */
export function updatePathSelection(state: ActivePathEditState, selection: PathPointSelection): ActivePathEditState {
 ...
 */
export function updatePathEditTool(state: ActivePathEditState, tool: PathEditTool): ActivePathEditState {
  return { ...state, tool };
}
 ...
 */
export function returnToActiveState(state: MovingPointsPathEditState | MovingHandlePathEditState): ActivePathEditState {
  return {
    type: "active",
    shapeId: state.shapeId,
    pathIndex: state.pathIndex,
