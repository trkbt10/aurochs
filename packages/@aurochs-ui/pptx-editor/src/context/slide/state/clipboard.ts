...
import type { ClipboardContent as CoreClipboardContent } from "@aurochs-ui/editor-core/clipboard";
import {
  createClipboardContent as createCoreClipboardContent,
  incrementPasteCount as incrementCorePasteCount,
} from "@aurochs-ui/editor-core/clipboard";
 ...
 */
export function createClipboardContent(shapes: readonly Shape[]): ClipboardContent {
 ...
 */
export function incrementPasteCount(clipboard: ClipboardContent): ClipboardContent {
