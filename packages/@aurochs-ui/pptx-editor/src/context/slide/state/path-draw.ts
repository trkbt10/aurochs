...
import type { DrawingPath, CapturedPoint, AnchorPointType } from "@aurochs-ui/path-tools";
import { createEmptyDrawingPath } from "@aurochs-ui/path-tools";
 ...
 */
export function createPencilDrawingState(firstPoint: CapturedPoint): PencilDrawingPathDrawState {
 ...
 */
export function isPathDrawIdle(state: PathDrawState): state is IdlePathDrawState {
 ...
 */
export function isPathDrawDrawing(state: PathDrawState): state is DrawingPathDrawState {
 ...
 */
export function isPathDrawDraggingHandle(state: PathDrawState): state is HandleDragPathDrawState {
 ...
 */
export function isPathDrawPencil(state: PathDrawState): state is PencilDrawingPathDrawState {
 ...
 */
export function updateDrawingPath(state: DrawingPathDrawState, path: DrawingPath): DrawingPathDrawState {
  return { ...state, path };
}
 ...
 */
export function setHoverPointIndex(state: DrawingPathDrawState, index: number | undefined): DrawingPathDrawState {
 ...
 */
export function updateHandleDrag(state: HandleDragPathDrawState, x: Pixels, y: Pixels): HandleDragPathDrawState {
