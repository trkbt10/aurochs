...
export function ThemeEditorTabs({
    ...
    () => [
      {
        id: "colors",
        label: "Colors",
        content: <ColorSchemeEditor colorScheme={colorScheme} onColorChange={onColorChange} disabled={disabled} />,
      },
      {
        id: "fonts",
        label: "Fonts",
      ...
      },
      {
        id: "presets",
        label: "Presets",
        content: <ThemePresetSelector onPresetSelect={onPresetSelect} disabled={disabled} />,
      },
    ],
  ...
  return (
    <div style={containerStyle}>
      <Tabs items={tabItems} value={activeTab} onChange={handleTabChange} size="sm" />
    </div>
  );
}
