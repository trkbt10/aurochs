...
function createTestContextValue(overrides: Partial<TextEditContextValue> = {}): TextEditContextValue {
...
function renderWithContext(contextValue: TextEditContextValue | null): ReturnType<typeof render> {
