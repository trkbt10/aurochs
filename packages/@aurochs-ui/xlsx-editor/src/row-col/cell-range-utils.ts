...
import type { XlsxColumnDef, XlsxRow } from "@aurochs-office/xlsx/domain/workbook";
 ...
 */
export function shiftCellAddressByAddress(address: CellAddress, rowDelta: number, colDelta: number): CellAddress {
 ...
 */
export function shiftCellRangeRowsInsert(range: CellRange, startRow: RowIndex, count: number): CellRange {
 ...
 */
export function shiftCellRangeRowsDelete(range: CellRange, startRow: RowIndex, count: number): CellRange | undefined {
  const minRow = Math.min(toRowNumber(range.start.row), toRowNumber(range.end.row));
  const maxRow = Math.max(toRowNumber(range.start.row), toRowNumber(range.end.row));
 ...
 */
export function shiftCellRangeColsInsert(range: CellRange, startCol: ColIndex, count: number): CellRange {
 ...
 */
export function shiftCellRangeColsDelete(range: CellRange, startCol: ColIndex, count: number): CellRange | undefined {
  const minCol = Math.min(toColNumber(range.start.col), toColNumber(range.end.col));
  const maxCol = Math.max(toColNumber(range.start.col), toColNumber(range.end.col));
 ...
 */
export function shiftRowNumbers(rows: readonly XlsxRow[], startRow: RowIndex, delta: number): readonly XlsxRow[] {
