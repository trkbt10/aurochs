 ...
 */
function findCurrentStyleIndex(styles: XlsxStyleSheet, currentStyleId: number | undefined): number | undefined {
...
function StyleCard({ styles, resolvedStyle, isSelected, disabled, canDelete, onClick, onDelete }: StyleCardProps) {
...
export function StyleSection({
  ...
  const currentIndex = useMemo(() => findCurrentStyleIndex(styles, currentStyleId), [styles, currentStyleId]);
