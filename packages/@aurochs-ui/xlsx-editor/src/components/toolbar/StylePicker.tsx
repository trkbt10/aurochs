...
import { Popover, ChevronDownIcon } from "@aurochs-ui/ui-components";
 ...
 */
function findCurrentCellStyleIndex(styles: XlsxStyleSheet, currentStyleId: number | undefined): number | undefined {
 ...
 */
export function StylePicker({ styles, currentStyleId, disabled, onNamedStyleSelect }: StylePickerProps) {
  ...
  const currentStyleOption = currentCellStyleIndex !== undefined ? styleOptions[currentCellStyleIndex] : undefined;
  ...
  return (
    <Popover trigger={trigger} open={isOpen} onOpenChange={setIsOpen} side="bottom" align="start" disabled={disabled}>
