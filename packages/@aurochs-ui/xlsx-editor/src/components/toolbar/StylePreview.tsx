...
function resolveFillBackground(styles: XlsxStyleSheet, cellXf: XlsxCellXf): string {
...
function resolveFontColor(styles: XlsxStyleSheet, cellXf: XlsxCellXf): string | undefined {
 ...
 */
export function StylePreview({ styles, cellXf, size = "sm" }: StylePreviewProps) {
