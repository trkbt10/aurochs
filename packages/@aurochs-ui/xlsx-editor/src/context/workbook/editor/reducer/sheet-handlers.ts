...
function handleAddSheet(state: XlsxEditorState, action: AddSheetAction): XlsxEditorState {
...
function handleDeleteSheet(state: XlsxEditorState, action: DeleteSheetAction): XlsxEditorState {
  const currentWorkbook = state.workbookHistory.present;
...
function handleRenameSheet(state: XlsxEditorState, action: RenameSheetAction): XlsxEditorState {
  const currentWorkbook = state.workbookHistory.present;
...
function handleSelectSheet(state: XlsxEditorState, action: SelectSheetAction): XlsxEditorState {
...
function handleMoveSheet(state: XlsxEditorState, action: MoveSheetAction): XlsxEditorState {
  const currentWorkbook = state.workbookHistory.present;
...
function handleDuplicateSheet(state: XlsxEditorState, action: DuplicateSheetAction): XlsxEditorState {
  const currentWorkbook = state.workbookHistory.present;
