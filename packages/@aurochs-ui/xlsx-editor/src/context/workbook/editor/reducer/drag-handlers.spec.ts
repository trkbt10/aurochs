...
describe("xlsx-editor/context/workbook/editor/reducer/drag-handlers", () => {
  it("START_RANGE_SELECT: starts drag state", () => {
    ...
    if (!handler) {
      throw new Error("START_RANGE_SELECT handler is not defined");
    }
  ...
  it("PREVIEW_RANGE_SELECT: updates preview range", () => {
    ...
    if (!previewHandler) {
      throw new Error("PREVIEW_RANGE_SELECT handler is not defined");
    }
  ...
  it("END_RANGE_SELECT: commits selection and ends drag", () => {
    ...
    if (!endHandler) {
      throw new Error("END_RANGE_SELECT handler is not defined");
    }
  ...
  it("COMMIT_ROW_RESIZE: commits row height and pushes history", () => {
    ...
    if (!startHandler) {
      throw new Error("START_ROW_RESIZE handler is not defined");
    }
    if (!previewHandler) {
      throw new Error("PREVIEW_ROW_RESIZE handler is not defined");
    }
    if (!commitHandler) {
      throw new Error("COMMIT_ROW_RESIZE handler is not defined");
    }
  ...
  it("COMMIT_FILL_DRAG: fills numeric series and pushes history", () => {
    ...
    if (!startHandler) {
      throw new Error("START_FILL_DRAG handler is not defined");
    }
    if (!previewHandler) {
      throw new Error("PREVIEW_FILL_DRAG handler is not defined");
    }
    if (!commitHandler) {
      throw new Error("COMMIT_FILL_DRAG handler is not defined");
    }
