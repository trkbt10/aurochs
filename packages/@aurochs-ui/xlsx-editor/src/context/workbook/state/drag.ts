 ...
 */
export function isDragIdle(drag: XlsxDragState): drag is { readonly type: "idle" } {
 ...
 */
export function isDragRangeSelect(drag: XlsxDragState): drag is {
 ...
 */
export function isDragFill(drag: XlsxDragState): drag is {
  readonly type: "fill";
 ...
 */
export function isDragRowResize(drag: XlsxDragState): drag is {
 ...
 */
export function isDragColumnResize(drag: XlsxDragState): drag is {
 ...
 */
export function updateRangeSelectDrag(drag: XlsxDragState, currentCell: CellAddress): XlsxDragState {
 ...
 */
export function updateFillDrag(drag: XlsxDragState, targetRange: CellRange): XlsxDragState {
  if (drag.type !== "fill") {
    return drag;
  }
  return {
 ...
 */
export function startRowResizeDrag(rowIndex: RowIndex, startY: number, originalHeight: number): XlsxDragState {
  return {
    type: "rowResize",
    rowIndex,
    startY,
 ...
 */
export function calculateRowResizeHeight(drag: XlsxDragState, currentY: number, minHeight = 0): number {
 ...
 */
export function startColumnResizeDrag(colIndex: ColIndex, startX: number, originalWidth: number): XlsxDragState {
  return {
    type: "columnResize",
    colIndex,
    startX,
 ...
 */
export function calculateColumnResizeWidth(drag: XlsxDragState, currentX: number, minWidth = 0): number {
