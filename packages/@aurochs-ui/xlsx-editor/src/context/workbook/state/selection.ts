 ...
 */
export function extendSelection(selection: CellSelectionState, toAddress: CellAddress): CellSelectionState {
 ...
 */
export function addRangeToSelection(selection: CellSelectionState, range: CellRange): CellSelectionState {
 ...
 */
export function isCellSelected(selection: CellSelectionState, address: CellAddress): boolean {
...
export function isSingleCellSelection(selection: CellSelectionState): boolean {
  ...
  return (
    start.col === end.col && start.row === end.row && (!selection.multiRanges || selection.multiRanges.length === 0)
  );
}
