...
import type { BlendMode, FigEffect, FigColor, FigEffectType } from "@aurochs/fig/types";
          ...
          <div key={i} style={{ ...effectItemStyle, opacity: effect.visible === false ? 0.4 : 1 }}>
            <div style={effectHeaderStyle}>
              <Toggle
                ...
                onChange={(checked) => updateEffect(i, (current) => ({ ...current, visible: checked }))}
              ...
              {isShadow && (
                <>
                  <Select<BlendMode>
                    ...
                    onChange={(value) => updateEffect(i, (current) => ({ ...current, blendMode: value }))}
                  ...
                  <Toggle
                    ...
                    onChange={(checked) => updateEffect(i, (current) => ({ ...current, showShadowBehindNode: checked }))}
                    label="Behind"
