...
const barShapeOptions: SelectOption<NonNullable<BarChartSeries["shape"]>>[] = [
  { value: "box", label: "Box" },
...
const sizeRepresentsOptions: SelectOption<NonNullable<BubbleChartSeries["sizeRepresents"]>>[] = [
...
export function ChartSeriesEditor({
  ...
  const updateLineField = useCallback(
    <K extends keyof LineChartSeries>(field: K, newValue: LineChartSeries[K]) => {
  ...
  const updateAreaField = useCallback(
    <K extends keyof AreaChartSeries>(field: K, newValue: AreaChartSeries[K]) => {
  ...
  const updatePieField = useCallback(
    <K extends keyof PieChartSeries>(field: K, newValue: PieChartSeries[K]) => {
      if (value.type === "pieChart" || value.type === "pie3DChart" || value.type === "doughnutChart") {
        onChange({ ...value, [field]: newValue } as ChartSeries);
      }
    },
    [value, onChange],
  ...
  const updateScatterField = useCallback(
    <K extends keyof ScatterChartSeries>(field: K, newValue: ScatterChartSeries[K]) => {
  ...
  const updateRadarField = useCallback(
    <K extends keyof RadarChartSeries>(field: K, newValue: RadarChartSeries[K]) => {
  ...
  const updateBubbleField = useCallback(
    <K extends keyof BubbleChartSeries>(field: K, newValue: BubbleChartSeries[K]) => {
  ...
  const updateOfPieField = useCallback(
    <K extends keyof OfPieChartSeries>(field: K, newValue: OfPieChartSeries[K]) => {
  ...
  const updateStockField = useCallback(
    <K extends keyof StockChartSeries>(field: K, newValue: StockChartSeries[K]) => {
  ...
  const updateSurfaceField = useCallback(
    <K extends keyof SurfaceChartSeries>(field: K, newValue: SurfaceChartSeries[K]) => {
  ...
  const isLineChart = value.type === "lineChart" || value.type === "line3DChart";
  const isAreaChart = value.type === "areaChart" || value.type === "area3DChart";
  const isPieChart = value.type === "pieChart" || value.type === "pie3DChart" || value.type === "doughnutChart";
  ...
  const isSurfaceChart = value.type === "surfaceChart" || value.type === "surface3DChart";
          ...
          <FieldRow>
            ...
            <FieldGroup label="Overlap" style={{ flex: 1 }}>
              <Input
                ...
                onChange={(v) => updateBarField("overlap", v ? Number(v) : undefined)}
                disabled={disabled}
              />
            </FieldGroup>
          </FieldRow>
              ...
              <FieldRow>
                ...
                <FieldGroup label="Shape" style={{ flex: 1 }}>
                  <Select
                    ...
                    onChange={(v) => updateBarField("shape", v as BarChartSeries["shape"])}
          ...
          <FieldRow>
            <FieldGroup label="Split Type" style={{ flex: 1 }}>
              <Select
                ...
                onChange={(v) => updateOfPieField("splitType", v as OfPieSplitType)}
            ...
            <FieldGroup label="Split Position" style={{ flex: 1 }}>
              <Input
                type="number"
                value={(value as OfPieChartSeries).splitPos?.toString() ?? ""}
                onChange={(v) => updateOfPieField("splitPos", v ? Number(v) : undefined)}
                disabled={disabled}
              />
            </FieldGroup>
          </FieldRow>
          ...
          <FieldRow>
            <FieldGroup label="Scatter Style" style={{ flex: 1 }}>
              <Select
                ...
                onChange={(v) => updateScatterField("scatterStyle", v as ScatterStyle)}
          ...
          <FieldRow>
            <FieldGroup label="Radar Style" style={{ flex: 1 }}>
              <Select
                ...
                onChange={(v) => updateRadarField("radarStyle", v as RadarStyle)}
          ...
          <FieldRow>
            ...
            <FieldGroup label="Size Represents" style={{ flex: 1 }}>
              <Select
                ...
                onChange={(v) => updateBubbleField("sizeRepresents", v as BubbleChartSeries["sizeRepresents"])}
...
function SeriesTextEditor({ value, onChange, disabled }: SeriesTextEditorProps) {
  const tx = value ?? {};
...
function UpDownBarsEditor({ value, onChange, disabled }: UpDownBarsEditorProps) {
  const bars = value ?? {};
...
function BandFormatsEditor({ value, onChange, disabled }: BandFormatsEditorProps) {
  const bands = value ?? [];
