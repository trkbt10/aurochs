 ...
 */
export function LayoutEditor({ value, onChange, disabled, className, style }: LayoutEditorProps) {
  const layout = value ?? {};
      ...
      <FieldRow>
        <FieldGroup label="Layout Target" style={{ flex: 1 }}>
          <Select
            ...
            onChange={(v) => updateManualLayout("layoutTarget", v as ManualLayout["layoutTarget"])}
      ...
      <FieldRow>
        <FieldGroup label="X Mode" style={{ flex: 1 }}>
          <Select
            ...
            onChange={(v) => updateManualLayout("xMode", v as ManualLayout["xMode"])}
            options={modeOptions}
            disabled={disabled}
          />
        </FieldGroup>
        <FieldGroup label="Y Mode" style={{ flex: 1 }}>
          <Select
            ...
            onChange={(v) => updateManualLayout("yMode", v as ManualLayout["yMode"])}
            options={modeOptions}
            disabled={disabled}
          />
        </FieldGroup>
      ...
      <FieldRow>
        <FieldGroup label="W Mode" style={{ flex: 1 }}>
          <Select
            ...
            onChange={(v) => updateManualLayout("wMode", v as ManualLayout["wMode"])}
            options={modeOptions}
            disabled={disabled}
          />
        </FieldGroup>
        <FieldGroup label="H Mode" style={{ flex: 1 }}>
          <Select
            ...
            onChange={(v) => updateManualLayout("hMode", v as ManualLayout["hMode"])}
            options={modeOptions}
            disabled={disabled}
          />
        </FieldGroup>
