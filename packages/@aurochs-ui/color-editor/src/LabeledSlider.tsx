 ...
 */
export function LabeledSlider({ label, value, onChange, min, max, suffix = "", labelColor }: LabeledSliderProps) {
  return (
    <div style={rowStyle}>
      <span style={labelColor ? { ...labelStyle, color: labelColor } : labelStyle}>{label}</span>
