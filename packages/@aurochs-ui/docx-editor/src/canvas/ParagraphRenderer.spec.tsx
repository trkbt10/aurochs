...
describe("ParagraphRenderer", () => {
  ...
  it("renders empty paragraph with non-breaking space", () => {
    ...
    const { container } = render(<ParagraphRenderer paragraph={paragraph} {...defaultProps} />);
  ...
  it("applies selected state styling", () => {
    ...
    const { container } = render(<ParagraphRenderer paragraph={paragraph} {...defaultProps} isSelected={true} />);
  ...
  it("applies editing state styling", () => {
    ...
    const { container } = render(<ParagraphRenderer paragraph={paragraph} {...defaultProps} isEditing={true} />);
  ...
  it("calls onClick when clicked", () => {
    ...
    const { container } = render(<ParagraphRenderer paragraph={paragraph} {...defaultProps} onClick={onClick} />);
  ...
  it("calls onDoubleClick when double-clicked", () => {
    ...
    const { container } = render(
      <ParagraphRenderer paragraph={paragraph} {...defaultProps} onDoubleClick={onDoubleClick} />,
    );
  ...
  it("sets data-element-id attribute", () => {
    ...
    const { container } = render(<ParagraphRenderer paragraph={paragraph} {...defaultProps} elementId="test-id" />);
