...
import type { DocxTableCell, DocxTableCellProperties } from "@aurochs-office/docx/domain/table";
  ...
  it("sets data attributes for row and col", () => {
    ...
    const { container } = render(
      <table>
        <tbody>
          <tr>
            <TableCellRenderer cell={cell} rowIndex={2} colIndex={3} isSelected={false} onClick={noopOnClick} />
          </tr>
        </tbody>
      </table>,
    );
