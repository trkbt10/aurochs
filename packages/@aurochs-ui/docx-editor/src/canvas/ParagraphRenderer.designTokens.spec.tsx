...
describe("ParagraphRenderer (design tokens)", () => {
  ...
  it("uses selection design tokens for outline and background", () => {
    ...
    expect(div.style.backgroundColor).toBe("color-mix(in srgb, var(--selection-primary) 5%, transparent)");
  });
  ...
  it("uses editing design token for background", () => {
    ...
    const div = container.firstChild as HTMLElement;
    expect(div.style.backgroundColor).toBe("color-mix(in srgb, var(--selection-primary) 8%, transparent)");
  });
