...
import type { DocxTableCell, DocxTableCellProperties, DocxCellBorders } from "@aurochs-office/docx/domain/table";
 ...
 */
function computeBorderStyle(edge: DocxCellBorders[keyof DocxCellBorders]): string {
  if (!edge) {
    return "none";
  }
 ...
 */
export function computeCellStyles(properties: DocxTableCellProperties | undefined): CSSProperties {
