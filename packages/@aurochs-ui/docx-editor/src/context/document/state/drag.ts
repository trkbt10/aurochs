 ...
 */
export function updateTextSelectDrag(state: TextSelectDragState, current: TextPosition): TextSelectDragState {
  return {
    ...state,
    current,
  };
 ...
 */
export function updateTableResizeDrag(state: TableResizeDragState, currentSize: number): TableResizeDragState {
  return {
    ...state,
    currentSize,
  };
