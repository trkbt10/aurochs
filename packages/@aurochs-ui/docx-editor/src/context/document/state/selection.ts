 ...
 */
export function toggleElementSelection(selection: ElementSelectionState, elementId: ElementId): ElementSelectionState {
 ...
 */
export function extendTextSelection(selection: TextSelectionState, toPosition: TextPosition): TextSelectionState {
 ...
 */
export function collapseTextSelection(selection: TextSelectionState, toEnd: boolean = false): TextSelectionState {
 ...
 */
export function isPositionInTextSelection(selection: TextSelectionState, position: TextPosition): boolean {
  if (!selection.range) {
    return false;
  }

  return comparePositions(position, selection.range.start) >= 0 && comparePositions(position, selection.range.end) < 0;
}
