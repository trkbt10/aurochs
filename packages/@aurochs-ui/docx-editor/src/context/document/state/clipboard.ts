...
import type { DocxTable, DocxTableRow, DocxTableCell } from "@aurochs-office/docx/domain/table";
 ...
 */
export type DocxClipboardContent = ParagraphClipboardContent | TableClipboardContent | TextClipboardContent;
 ...
 */
export function createTableClipboard(table: DocxTable, isCut: boolean = false): TableClipboardContent {
  return {
    type: "table",
    table,
    isCut,
 ...
 */
export function isParagraphClipboard(content: DocxClipboardContent): content is ParagraphClipboardContent {
 ...
 */
export function isTableClipboard(content: DocxClipboardContent): content is TableClipboardContent {
 ...
 */
export function isTextClipboard(content: DocxClipboardContent): content is TextClipboardContent {
