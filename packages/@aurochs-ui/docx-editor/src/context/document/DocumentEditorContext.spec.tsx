...
import { DocumentEditorProvider, useDocumentEditor, useDocumentEditorOptional } from "./DocumentEditorContext";
...
describe("DocumentEditorContext", () => {
  ...
  describe("useDocumentEditorOptional", () => {
    ...
    it("returns context when used inside provider", () => {
      ...
      const { result } = renderHook(() => useDocumentEditorOptional(), {
        wrapper: ({ children }) => (
          <DocumentEditorProvider initialDocument={document}>{children}</DocumentEditorProvider>
        ),
      });
