...
import { buildCharacterPropertiesMap, findCommonPrefixSuffix, createRunsFromPropertiesMap } from "./character-mapping";
      ...
      content: [
        {
          type: "hyperlink",
          rId: docxRelId("rId1"),
          content: [{ type: "run", properties: linkProps, content: [{ type: "text", value: "Link" }] }],
        },
      ],
    };
    const map = buildCharacterPropertiesMap(paragraph);
