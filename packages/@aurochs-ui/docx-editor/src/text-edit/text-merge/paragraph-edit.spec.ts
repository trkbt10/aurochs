...
import { mergeTextIntoParagraph, insertTextAtOffset, deleteTextRange, replaceTextRange } from "./paragraph-edit";
...
describe("insertTextAtOffset", () => {
  ...
  it("preserves formatting at insertion point", () => {
    const paragraph = createParagraphWithRuns([{ text: "AB", properties: { b: true } }, { text: "CD" }]);
