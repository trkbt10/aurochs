...
describe("syncParagraphsWithPlainText", () => {
  ...
  it("syncs multiple paragraphs", () => {
    const paragraphs = [createParagraphWithRuns([{ text: "Line 1" }]), createParagraphWithRuns([{ text: "Line 2" }])];
  ...
  it("preserves formatting in existing paragraphs", () => {
    const paragraphs = [createParagraphWithRuns([{ text: "Bold", properties: { b: true } }, { text: "Normal" }])];
