 ...
 */
export function offsetToDocxCursorPosition(content: readonly DocxBlockContent[], offset: number): DocxCursorPosition {
 ...
 */
export function docxCursorPositionToOffset(content: readonly DocxBlockContent[], position: DocxCursorPosition): number {
 ...
 */
export function getWordRange(text: string, offset: number): { start: number; end: number } {
  if (text.length === 0) {
 ...
 */
export function getSelectionLength(content: readonly DocxBlockContent[], selection: DocxTextSelection): number {
