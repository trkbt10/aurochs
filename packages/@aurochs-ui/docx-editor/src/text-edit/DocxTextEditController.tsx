...
import { type DocxCursorPosition, getPlainTextFromParagraph } from "./cursor";
...
export type DocxTextEditControllerProps = {
  ...
  readonly onSelectionChange: (selection: { start: DocxCursorPosition; end: DocxCursorPosition }) => void;
 ...
 */
function createInitialState(paragraph: DocxParagraph, initialCursorPosition?: DocxCursorPosition): TextEditLocalState {
...
export function DocxTextEditController({
  ...
  // Local editing state
  const [state, setState] = useState<TextEditLocalState>(() => createInitialState(paragraph, initialCursorPosition));
