...
import type { DocxLevel, DocxLevelJustification } from "@aurochs-office/docx/domain/numbering";
import type { NumberFormat, LevelSuffix } from "@aurochs-office/ooxml";
import type { DocxIlvl } from "@aurochs-office/docx/domain/types";
import { ToggleButton, Input, Select, Toggle } from "@aurochs-ui/ui-components/primitives";
 ...
 */
export function NumberingLevelEditor({ value, onChange, disabled, className, style }: NumberingLevelEditorProps) {
