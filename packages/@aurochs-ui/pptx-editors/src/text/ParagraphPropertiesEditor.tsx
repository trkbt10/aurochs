...
import type { ParagraphProperties, BulletStyle, RunProperties } from "@aurochs-office/pptx/domain/text";
...
export function ParagraphPropertiesEditor({
  ...
  return (
    <div style={{ ...containerStyle, ...style }} className={className}>
      ...
      {showBullet && (
        <>
          <Button variant="ghost" onClick={toggleBullet} disabled={disabled} style={{ alignSelf: "flex-start" }}>
