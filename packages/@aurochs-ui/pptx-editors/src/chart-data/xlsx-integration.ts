...
import { createInitialState, xlsxEditorReducer, type XlsxEditorAction } from "@aurochs-ui/xlsx-editor";
 ...
 */
export function createChartDataEditor(workbook: XlsxWorkbook, sheetIndex: number = 0): ChartDataEditor {
