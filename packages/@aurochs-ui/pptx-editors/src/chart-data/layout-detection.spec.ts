...
describe("detectChartDataLayout", () => {
  ...
  it("handles single row data", () => {
    ...
    // Row 2: ("Cat1", 10)
    const worksheet = createWorksheet([
      createRow(1, [createCell(1, 1, emptyValue()), createCell(2, 1, stringValue("Series1"))]),
      createRow(2, [createCell(1, 2, stringValue("Cat1")), createCell(2, 2, numberValue(10))]),
    ]);
  ...
  it("counts categories correctly with gaps in data", () => {
    ...
    const worksheet = createWorksheet([
      createRow(1, [createCell(1, 1, emptyValue()), createCell(2, 1, stringValue("Series1"))]),
      createRow(2, [createCell(1, 2, stringValue("Cat1")), createCell(2, 2, numberValue(10))]),
      createRow(3, [createCell(1, 3, emptyValue()), createCell(2, 3, numberValue(20))]),
      createRow(4, [createCell(1, 4, stringValue("Cat3")), createCell(2, 4, numberValue(30))]),
      createRow(5, [createCell(1, 5, stringValue("Cat4")), createCell(2, 5, numberValue(40))]),
    ]);
