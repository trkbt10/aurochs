...
import type { OleReference, OleObjectFollowColorScheme } from "@aurochs-office/pptx/domain/shape";
 ...
 */
export function OleObjectEditor({ value, onChange, disabled, className, style }: OleObjectEditorProps) {
    ...
    <div style={{ ...containerStyle, ...style }} className={className}>
      ...
      <div style={infoStyle}>
        ...
        {!value.progId && !value.resourceId && (
          <span style={{ color: "var(--text-tertiary, #737373)" }}>Embedded OLE Object</span>
        )}
      </div>

      {/* Editable Fields */}
      <FieldGroup label="Name">
        <Input value={value.name ?? ""} onChange={handleNameChange} disabled={disabled} placeholder="(unnamed)" />
      </FieldGroup>
