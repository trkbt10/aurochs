 ...
 */
export function SlideContextMenu({ x, y, primaryShape, selectedShapes, actions, onClose }: SlideContextMenuProps) {
  ...
  return <ContextMenu x={x} y={y} items={menuItems} onAction={handleAction} onClose={onClose} />;
}
