...
import type { TextSelectionContext } from "@aurochs-ui/ooxml-components/drawing-ml/text/text-property-extractor";
...
export type TextEditContextValue = {
  ...
  readonly toggleRunProperty: (propertyKey: keyof RunProperties, currentValue: boolean | undefined) => void;
 ...
 */
export function TextEditContextProvider({ children, value }: TextEditContextProviderProps) {
  return <TextEditContext.Provider value={value}>{children}</TextEditContext.Provider>;
}
 ...
 */
export function createTextEditContextValue(params: CreateTextEditContextValueParams): TextEditContextValue {
  return {
 ...
 */
export function useTextEditContextValue(params: CreateTextEditContextValueParams): TextEditContextValue {
  return useMemo(
