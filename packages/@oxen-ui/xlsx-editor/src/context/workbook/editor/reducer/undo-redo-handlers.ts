...
export const undoRedoHandlers: HandlerMap = {
  UNDO: (state) => {
    ...
    const activeSheetIndex = normalizeActiveSheetIndex(
      state.activeSheetIndex,
      workbookHistory.present.sheets.length,
	    );
