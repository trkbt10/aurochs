...
import type { DataTable, ChartShapeProperties } from "@oxen-office/chart/domain";
...
function renderSeriesRow(
  ...
  if (showVertBorder) {
    elements.push(
      renderVerticalBorder({ x: seriesNameWidth, y: rowY, height: DATA_TABLE_ROW_HEIGHT, borderStyle })
    );
  }
