...
import type { ErrorBars, ChartShapeProperties, DataReference } from "@oxen-office/chart/domain";
 ...
 */
function getErrorBarStyle(spPr: ChartShapeProperties | undefined, fillResolver: FillResolver): {
  color: string;
  width: number;
  capWidth: number;
} {
