...
import type { SeriesData, ValueAxisConfig, ChartContent, BarChartConfig } from "../render-types";
...
export function generateBarChart(
  ...
  const { minVal, maxVal } = resolveBarValueRange(
    { data, axisConfig, numCategories, isStacked, isPercentStacked }
  );
