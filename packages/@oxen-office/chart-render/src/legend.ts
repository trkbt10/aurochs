...
import type { Legend, LegendEntry, ChartShapeProperties, Layout } from "@oxen-office/chart/domain";
...
export function renderLegend(
  ...
  const pos = calculateLegendPosition({ position: legend.position, chartWidth, chartHeight, legendWidth, legendHeight });
  ...
  items.push(renderLegendBackground({ x: pos.x, y: pos.y, width: legendWidth, height: legendHeight, spPr: legend.shapeProperties, fillResolver }));
