 ...
 */
export function wEl(localName: string, attrs: Record<string, string> = {}, children: readonly XmlNode[] = []): XmlElement {
 ...
 */
export function optAttr(attrs: Record<string, string>, name: string, value: string | number | boolean | undefined): void {
