...
import type { Shape, SpShape, GrpShape, PicShape, CxnShape, GraphicFrame, NonVisualProperties, Geometry, PresetGeometry, CustomGeometry, GeometryPath, PathCommand, ConnectionTarget, OleReference } from "@oxen-office/pptx/domain";
