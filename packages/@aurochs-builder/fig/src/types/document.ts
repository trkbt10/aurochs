 ...
 *
 * The key differences from the raw FigNode tree (@aurochs/fig):
...
import type { FigNodeType, FigMatrix, FigVector, FigColor, FigPaint, FigEffect, FigStrokeWeight, KiwiEnumValue } from "@aurochs/fig/types";
