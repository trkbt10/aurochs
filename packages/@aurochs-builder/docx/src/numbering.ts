...
export function serializeLevel(level: DocxLevel): XmlElement {
  ...
  if (level.lvlText) {
    ...
    if (level.lvlText.val !== undefined) {
      attrs["w:val"] = level.lvlText.val;
    }
    if (level.lvlText.null !== undefined) {
      attrs["w:null"] = level.lvlText.null ? "1" : "0";
    }
  ...
  if (level.legacy) {
    ...
    if (level.legacy.legacy !== undefined) {
      legacyAttrs["w:legacy"] = level.legacy.legacy ? "1" : "0";
    }
    if (level.legacy.legacySpace !== undefined) {
      legacyAttrs["w:legacySpace"] = String(level.legacy.legacySpace);
    }
    if (level.legacy.legacyIndent !== undefined) {
      legacyAttrs["w:legacyIndent"] = String(level.legacy.legacyIndent);
    }
