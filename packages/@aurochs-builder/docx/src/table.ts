...
export function serializeTableWidth(width: TableWidth, elementName: string): XmlElement {
  ...
  if (width.value !== undefined) {
    attrs["w:w"] = String(width.value);
  }
  if (width.type) {
    attrs["w:type"] = width.type;
  }
...
export function serializeTableCellSpacing(spacing: DocxTableCellSpacing, elementName: string): XmlElement {
  ...
  if (spacing.w !== undefined) {
    attrs["w:w"] = String(spacing.w);
  }
  if (spacing.type) {
    attrs["w:type"] = spacing.type;
  }
...
function serializeBorderEdge(border: DocxTableBorderEdge, name: string): XmlElement {
  ...
  if (border.val) {
    attrs["w:val"] = border.val;
  }
  if (border.sz !== undefined) {
    attrs["w:sz"] = String(border.sz);
  }
...
export function serializeTableBorders(borders: DocxTableBorders): XmlElement {
  ...
  if (borders.top) {
    children.push(serializeBorderEdge(borders.top, "top"));
  }
  if (borders.left) {
    children.push(serializeBorderEdge(borders.left, "left"));
  }
  if (borders.bottom) {
    children.push(serializeBorderEdge(borders.bottom, "bottom"));
  }
  if (borders.right) {
    children.push(serializeBorderEdge(borders.right, "right"));
  }
  if (borders.insideH) {
    children.push(serializeBorderEdge(borders.insideH, "insideH"));
  }
  if (borders.insideV) {
    children.push(serializeBorderEdge(borders.insideV, "insideV"));
  }
...
export function serializeTableProperties(props: DocxTableProperties | undefined): XmlElement | undefined {
  ...
  if (props.tblpPr) {
    ...
    if (props.tblpPr.leftFromText !== undefined) {
      tblpPrAttrs["w:leftFromText"] = String(props.tblpPr.leftFromText);
    }
    if (props.tblpPr.rightFromText !== undefined) {
      tblpPrAttrs["w:rightFromText"] = String(props.tblpPr.rightFromText);
    }
    if (props.tblpPr.topFromText !== undefined) {
      tblpPrAttrs["w:topFromText"] = String(props.tblpPr.topFromText);
    }
    if (props.tblpPr.bottomFromText !== undefined) {
      tblpPrAttrs["w:bottomFromText"] = String(props.tblpPr.bottomFromText);
    }
    if (props.tblpPr.vertAnchor) {
      tblpPrAttrs["w:vertAnchor"] = props.tblpPr.vertAnchor;
    }
    if (props.tblpPr.horzAnchor) {
      tblpPrAttrs["w:horzAnchor"] = props.tblpPr.horzAnchor;
    }
    if (props.tblpPr.tblpX !== undefined) {
      tblpPrAttrs["w:tblpX"] = String(props.tblpPr.tblpX);
    }
    if (props.tblpPr.tblpXSpec) {
      tblpPrAttrs["w:tblpXSpec"] = props.tblpPr.tblpXSpec;
    }
    if (props.tblpPr.tblpY !== undefined) {
      tblpPrAttrs["w:tblpY"] = String(props.tblpPr.tblpY);
    }
    if (props.tblpPr.tblpYSpec) {
      tblpPrAttrs["w:tblpYSpec"] = props.tblpPr.tblpYSpec;
    }
  ...
  // Table width
  if (props.tblW) {
    children.push(serializeTableWidth(props.tblW, "tblW"));
  }
  ...
  if (props.tblCellSpacing) {
    children.push(serializeTableCellSpacing(props.tblCellSpacing, "tblCellSpacing"));
  }

  // Table indent
  if (props.tblInd) {
    children.push(serializeTableWidth(props.tblInd, "tblInd"));
  }

  // Table borders
  if (props.tblBorders) {
    children.push(serializeTableBorders(props.tblBorders));
  }

  // Shading
  if (props.shd) {
    children.push(serializeShading(props.shd, "w:shd"));
  }
  ...
  // Cell margins
  if (props.tblCellMar) {
    children.push(serializeTableCellMargins(props.tblCellMar, "tblCellMar"));
  }

  // Table look
  if (props.tblLook) {
    const lookAttrs: Record<string, string> = {};
    if (props.tblLook.firstRow !== undefined) {
      lookAttrs["w:firstRow"] = props.tblLook.firstRow ? "1" : "0";
    }
    if (props.tblLook.lastRow !== undefined) {
      lookAttrs["w:lastRow"] = props.tblLook.lastRow ? "1" : "0";
    }
    if (props.tblLook.firstColumn !== undefined) {
      lookAttrs["w:firstColumn"] = props.tblLook.firstColumn ? "1" : "0";
    }
    if (props.tblLook.lastColumn !== undefined) {
      lookAttrs["w:lastColumn"] = props.tblLook.lastColumn ? "1" : "0";
    }
    if (props.tblLook.noHBand !== undefined) {
      lookAttrs["w:noHBand"] = props.tblLook.noHBand ? "1" : "0";
    }
    if (props.tblLook.noVBand !== undefined) {
      lookAttrs["w:noVBand"] = props.tblLook.noVBand ? "1" : "0";
    }
...
export function serializeTableGrid(grid: DocxTableGrid): XmlElement {
  const children = grid.columns.map((col) => createElement("w:gridCol", { "w:w": String(col.width) }));
...
function serializeRowHeight(height: DocxRowHeight): XmlElement {
  ...
  if (height.val !== undefined) {
    attrs["w:val"] = String(height.val);
  }
  if (height.hRule) {
    attrs["w:hRule"] = height.hRule;
  }
...
export function serializeTableRowProperties(props: DocxTableRowProperties | undefined): XmlElement | undefined {
  ...
  // Width before
  if (props.wBefore) {
    children.push(serializeTableWidth(props.wBefore, "wBefore"));
  }

  // Width after
  if (props.wAfter) {
    children.push(serializeTableWidth(props.wAfter, "wAfter"));
  }

  // Row height
  if (props.trHeight) {
    children.push(serializeRowHeight(props.trHeight));
  }
...
export function serializeTableCellBorders(borders: DocxCellBorders): XmlElement {
  ...
  if (borders.tl2br) {
    children.push(serializeBorderEdge(borders.tl2br, "tl2br"));
  }
  if (borders.tr2bl) {
    children.push(serializeBorderEdge(borders.tr2bl, "tr2bl"));
  }
...
export function serializeTableCellProperties(props: DocxTableCellProperties | undefined): XmlElement | undefined {
  ...
  // Cell borders
  if (props.tcBorders) {
    children.push(serializeTableCellBorders(props.tcBorders));
  }
  ...
  // Cell margins
  if (props.tcMar) {
    children.push(serializeTableCellMargins(props.tcMar, "tcMar"));
  }
