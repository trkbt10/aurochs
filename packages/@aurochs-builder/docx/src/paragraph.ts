...
export function serializeSpacing(spacing: DocxParagraphSpacing): XmlElement {
  ...
  if (spacing.before !== undefined) {
    attrs["w:before"] = String(spacing.before);
  }
  if (spacing.beforeLines !== undefined) {
    attrs["w:beforeLines"] = String(spacing.beforeLines);
  }
  if (spacing.beforeAutospacing !== undefined) {
    attrs["w:beforeAutospacing"] = spacing.beforeAutospacing ? "1" : "0";
  }
  if (spacing.after !== undefined) {
    attrs["w:after"] = String(spacing.after);
  }
  if (spacing.afterLines !== undefined) {
    attrs["w:afterLines"] = String(spacing.afterLines);
  }
  if (spacing.afterAutospacing !== undefined) {
    attrs["w:afterAutospacing"] = spacing.afterAutospacing ? "1" : "0";
  }
  if (spacing.line !== undefined) {
    attrs["w:line"] = String(spacing.line);
  }
  if (spacing.lineRule) {
    attrs["w:lineRule"] = spacing.lineRule;
  }
...
export function serializeIndent(indent: DocxParagraphIndent): XmlElement {
  ...
  if (indent.left !== undefined) {
    attrs["w:left"] = String(indent.left);
  }
  if (indent.leftChars !== undefined) {
    attrs["w:leftChars"] = String(indent.leftChars);
  }
  if (indent.right !== undefined) {
    attrs["w:right"] = String(indent.right);
  }
  if (indent.rightChars !== undefined) {
    attrs["w:rightChars"] = String(indent.rightChars);
  }
  if (indent.hanging !== undefined) {
    attrs["w:hanging"] = String(indent.hanging);
  }
  if (indent.hangingChars !== undefined) {
    attrs["w:hangingChars"] = String(indent.hangingChars);
  }
  if (indent.firstLine !== undefined) {
    attrs["w:firstLine"] = String(indent.firstLine);
  }
  if (indent.firstLineChars !== undefined) {
    attrs["w:firstLineChars"] = String(indent.firstLineChars);
  }
...
export function serializeParagraphBorders(borders: DocxParagraphBorders): XmlElement {
  ...
  if (borders.between) {
    children.push(serializeBorderEdge(borders.between, "between"));
  }
  if (borders.bar) {
    children.push(serializeBorderEdge(borders.bar, "bar"));
  }
...
function serializeTabStop(tab: DocxTabStop): XmlElement {
  ...
  if (tab.pos !== undefined) {
    attrs["w:pos"] = String(tab.pos);
  }
  if (tab.leader) {
...
export function serializeFrameProperties(framePr: DocxFrameProperties): XmlElement {
  ...
  if (framePr.w !== undefined) {
    attrs["w:w"] = String(framePr.w);
  }
  if (framePr.h !== undefined) {
    attrs["w:h"] = String(framePr.h);
  }
  if (framePr.hRule) {
    attrs["w:hRule"] = framePr.hRule;
  }
  if (framePr.hSpace !== undefined) {
    attrs["w:hSpace"] = String(framePr.hSpace);
  }
  if (framePr.vSpace !== undefined) {
    attrs["w:vSpace"] = String(framePr.vSpace);
  }
  if (framePr.wrap) {
    attrs["w:wrap"] = framePr.wrap;
  }
  if (framePr.hAnchor) {
    attrs["w:hAnchor"] = framePr.hAnchor;
  }
  if (framePr.vAnchor) {
    attrs["w:vAnchor"] = framePr.vAnchor;
  }
  if (framePr.x !== undefined) {
    attrs["w:x"] = String(framePr.x);
  }
  if (framePr.xAlign) {
    attrs["w:xAlign"] = framePr.xAlign;
  }
  if (framePr.y !== undefined) {
    attrs["w:y"] = String(framePr.y);
  }
  if (framePr.yAlign) {
    attrs["w:yAlign"] = framePr.yAlign;
  }
  if (framePr.anchorLock !== undefined) {
    attrs["w:anchorLock"] = framePr.anchorLock ? "1" : "0";
  }
  if (framePr.dropCap) {
    attrs["w:dropCap"] = framePr.dropCap;
  }
  if (framePr.lines !== undefined) {
    attrs["w:lines"] = String(framePr.lines);
  }
...
export function serializeParagraphProperties(props: DocxParagraphProperties | undefined): XmlElement | undefined {
  ...
  // Frame properties
  if (props.framePr) {
    children.push(serializeFrameProperties(props.framePr));
  }
  ...
  if (props.numPr) {
    children.push(serializeNumberingProperties(props.numPr));
  }
  ...
  // Paragraph borders
  if (props.pBdr) {
    children.push(serializeParagraphBorders(props.pBdr));
  }
  ...
  // Tab stops
  if (props.tabs) {
    children.push(serializeTabStops(props.tabs));
  }
  ...
  // Spacing
  if (props.spacing) {
    children.push(serializeSpacing(props.spacing));
  }

  // Indent
  if (props.ind) {
    children.push(serializeIndent(props.ind));
  }
...
export function serializeHyperlink(hyperlink: DocxHyperlink): XmlElement {
  ...
  if (hyperlink.rId) {
    attrs["r:id"] = hyperlink.rId;
  }
  if (hyperlink.anchor) {
    attrs["w:anchor"] = hyperlink.anchor;
  }
  if (hyperlink.tooltip) {
    attrs["w:tooltip"] = hyperlink.tooltip;
  }
  if (hyperlink.tgtFrame) {
    attrs["w:tgtFrame"] = hyperlink.tgtFrame;
  }
  if (hyperlink.history !== undefined) {
    attrs["w:history"] = hyperlink.history ? "1" : "0";
  }
