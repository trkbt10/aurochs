...
import { NS_WORDPROCESSINGML } from "@aurochs-office/docx/constants";
...
export function serializeLatentStyleException(exception: DocxLatentStyleException): XmlElement {
  ...
  if (exception.locked !== undefined) {
    attrs["w:locked"] = exception.locked ? "1" : "0";
  }
  if (exception.uiPriority !== undefined) {
    attrs["w:uiPriority"] = String(exception.uiPriority);
  }
  if (exception.semiHidden !== undefined) {
    attrs["w:semiHidden"] = exception.semiHidden ? "1" : "0";
  }
  if (exception.unhideWhenUsed !== undefined) {
    attrs["w:unhideWhenUsed"] = exception.unhideWhenUsed ? "1" : "0";
  }
  if (exception.qFormat !== undefined) {
    attrs["w:qFormat"] = exception.qFormat ? "1" : "0";
  }
...
export function serializeStyle(style: DocxStyle): XmlElement {
  ...
  if (style.default !== undefined) {
    attrs["w:default"] = style.default ? "1" : "0";
  }
  if (style.customStyle !== undefined) {
    attrs["w:customStyle"] = style.customStyle ? "1" : "0";
  }
