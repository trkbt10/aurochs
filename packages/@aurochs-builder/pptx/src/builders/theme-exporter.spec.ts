...
function minimalTheme(): Theme {
  return {
    ...
    formatScheme: {
      fillStyles: [createElement("a:solidFill", {}, [createElement("a:schemeClr", { val: "phClr" })])],
      lineStyles: [createElement("a:ln", { w: "6350" })],
      effectStyles: [createElement("a:effectStyle", {}, [createElement("a:effectLst")])],
      bgFillStyles: [createElement("a:solidFill", {}, [createElement("a:schemeClr", { val: "phClr" })])],
    },
    customColors: [],
    extraColorSchemes: [],
    objectDefaults: {},
