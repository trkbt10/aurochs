...
function updateTxStyles(masterXml: XmlDocument, updater: (txStyles: XmlElement) => XmlElement): XmlDocument {
 ...
 */
export function patchMasterShapes(masterXml: XmlDocument, changes: readonly ShapeChange[]): XmlDocument {
 ...
 */
export function patchTitleStyle(masterXml: XmlDocument, titleStyle: TextStyleLevels): XmlDocument {
 ...
 */
export function patchBodyStyle(masterXml: XmlDocument, bodyStyle: TextStyleLevels): XmlDocument {
  return updateTxStyles(masterXml, (txStyles) => {
 ...
 */
export function patchDefaultTextStyle(masterXml: XmlDocument, level: number, style: ParagraphProperties): XmlDocument {
  if (!style) {
