...
import { createElement, createText, getChild, isXmlElement, removeChildren, replaceChildByName, setChildren, type XmlElement } from "@aurochs/xml";
...
/** Patch the table style ID reference on a table element */
