 ...
 */
export type ShapeChange = ShapeModified | ShapeAdded | ShapeRemoved;
 ...
 */
export function detectSlideChanges(original: Slide, modified: Slide): readonly ShapeChange[] {
 ...
 */
export function detectShapePropertyChanges(original: Shape, modified: Shape): readonly PropertyChange[] {
 ...
 */
function detectSpShapeChanges(original: SpShape, modified: SpShape): PropertyChange[] {
  const changes: PropertyChange[] = [];
 ...
 */
function detectPicShapeChanges(original: PicShape, modified: PicShape): PropertyChange[] {
  const changes: PropertyChange[] = [];
 ...
 */
function detectGrpShapeChanges(original: GrpShape, modified: GrpShape): PropertyChange[] {
  const changes: PropertyChange[] = [];
 ...
 */
function detectCxnShapeChanges(original: CxnShape, modified: CxnShape): PropertyChange[] {
  const changes: PropertyChange[] = [];
 ...
 */
function detectGraphicFrameChanges(original: GraphicFrame, modified: GraphicFrame): PropertyChange[] {
  const changes: PropertyChange[] = [];
 ...
 */
export function isTransformEqual(a: Transform | undefined, b: Transform | undefined): boolean {
  if (a === b) {
    return true;
  }
  if (!a || !b) {
 ...
 */
export function isTextBodyEqual(a: TextBody | undefined, b: TextBody | undefined): boolean {
  if (a === b) {
    return true;
  }
  if (!a || !b) {
 ...
 */
export function isEffectsEqual(a: Effects | undefined, b: Effects | undefined): boolean {
  if (a === b) {
    return true;
  }
  if (!a || !b) {
 ...
 */
export function isGeometryEqual(a: unknown, b: unknown): boolean {
  return deepEqual(a, b);
}
...
export function getModifiedByProperty<T extends PropertyChange["property"]>(
  ...
  return change.changes.find((c): c is Extract<PropertyChange, { property: T }> => c.property === property);
}
