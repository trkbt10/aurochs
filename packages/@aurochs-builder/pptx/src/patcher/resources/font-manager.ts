 ...
 */
export function embedFonts(pkg: ZipPackage, fonts: readonly EmbeddedFontData[]): FontEmbedResult {
 ...
 * Update presentation.xml with embedded font list.
 */
function updatePresentationWithFonts(pkg: ZipPackage, fontRefs: Array<{ fontFamily: string; rId: string }>): void {
 ...
 */
function createEmbeddedFontListElement(fontRefs: Array<{ fontFamily: string; rId: string }>) {
