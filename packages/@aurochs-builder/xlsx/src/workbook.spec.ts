...
describe("serializeSheets", () => {
  it("should serialize single sheet", () => {
    ...
    expect(xml).toBe('<sheets><sheet name="Sheet1" sheetId="1" r:id="rId1"/></sheets>');
  });

  it("should serialize multiple sheets", () => {
    const sheets = [createWorksheet("Sheet1", 1), createWorksheet("Sheet2", 2), createWorksheet("Sheet3", 3)];
  ...
  it("should throw error for missing relationship ID", () => {
    ...
    expect(() => serializeSheets(sheets, relationships)).toThrow("Missing relationship ID for sheet at index 0");
  });
  ...
  it("should preserve sheet order", () => {
    const sheets = [createWorksheet("First", 1), createWorksheet("Second", 2), createWorksheet("Third", 3)];
    const relationships = createRelationships(3);
...
describe("serializeDefinedNames", () => {
  ...
  it("should serialize single global defined name", () => {
    const definedNames: XlsxDefinedName[] = [{ name: "MyRange", formula: "Sheet1!$A$1:$B$10" }];
  ...
  it("should serialize hidden defined name", () => {
    const definedNames: XlsxDefinedName[] = [{ name: "HiddenName", formula: "Sheet1!$A$1", hidden: true }];
...
describe("serializeRelationships", () => {
  it("should serialize empty relationships", () => {
    ...
    expect(xml).toBe('<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"/>');
  });
  ...
  it("should serialize single relationship", () => {
    ...
    expect(xml).toContain('Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet"');
