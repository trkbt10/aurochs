...
import { serializeCell, serializeCellValue, serializeFormula, type SharedStringTable } from "./cell";
...
describe("serializeCellValue", () => {
  ...
  it("should serialize error values", () => {
    const errorCodes = ["#NULL!", "#DIV/0!", "#VALUE!", "#REF!", "#NAME?", "#NUM!", "#N/A", "#GETTING_DATA"] as const;
