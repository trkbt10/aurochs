...
import { indexToColumnLetter, columnLetterToIndex } from "@aurochs-office/xlsx/domain/cell/address";
 ...
 */
export function serializeIntOptional(value: number | undefined): string | undefined {
 ...
 */
export function serializeFloatOptional(value: number | undefined): string | undefined {
 ...
 */
export function serializeBooleanOptional(value: boolean | undefined): string | undefined {
