 ...
 * | empty          | -           | -                            |
 */
export function serializeCellValue(value: CellValue, sharedStrings: SharedStringTable): CellValueSerializeResult {
  switch (value.type) {
    case "number":
 ...
 */
export function serializeCell(cell: Cell, sharedStrings: SharedStringTable): XmlElement {
  const attrs: Record<string, string> = {};
