...
import type {
  ...
  DocxOutlineLevel,
  DocxHighlightColor,
} from "@aurochs-office/docx";
import type { ParagraphAlignment } from "@aurochs-office/ooxml/domain/text";
import type { UnderlineStyle } from "@aurochs-office/ooxml/domain/text";
import type { WordBorderStyle } from "@aurochs-office/ooxml/domain/border";
import type { SectionBreakType } from "@aurochs-office/docx";
import { halfPoints, twips, docxNumId, docxIlvl } from "@aurochs-office/docx";
...
function convertParagraphProperties(para: DocParagraph): DocxParagraphProperties | undefined {
  ...
  // Spacing
  const hasSpacing =
    para.spaceBefore !== undefined ||
    para.spaceAfter !== undefined ||
