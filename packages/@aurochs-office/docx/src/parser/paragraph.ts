...
import type { DocxInlineSdt, DocxSdtProperties, DocxSdtLock, DocxSdtListItem } from "../domain/sdt";
import { parseOfficeMath, parseOfficeMathPara } from "./math";
import type { ParagraphAlignment, TabStopAlignment, TabStopLeader } from "@aurochs-office/ooxml/domain/text";
...
): "top" | "center" | "bottom" | "inside" | "outside" | "inline" | undefined {
  switch (value) {
    case "top":
    case "center":
    case "bottom":
...
function parseWrap(
  value: string | undefined,
): "around" | "auto" | "none" | "notBeside" | "through" | "tight" | undefined {
  switch (value) {
    case "around":
    case "auto":
    case "none":
