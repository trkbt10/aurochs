...
import { SPEC_DEFAULT_FONT_SIZE_PT, TWIPS_PER_POINT, PT_TO_PX } from "../domain/ecma376-defaults";
 ...
 */
function mergeRunProperties(base: DocxRunProperties, override: DocxRunProperties): DocxRunProperties {
  return {
    ...base,
    ...override,
...
export function resolveRunPropertiesWithStyles(params: {
  ...
  const withParagraphRPr =
    paragraphRPr !== undefined ? applyOverrides(baseCharacterStyle, paragraphRPr) : baseCharacterStyle;
 ...
 */
function applyOverrides(base: ResolvedRunProperties, overrides: DocxRunProperties): ResolvedRunProperties {
  return {
    ...base,
...
function resolveTextDecoration(overrides: DocxRunProperties, baseDecoration: string | undefined): string | undefined {
