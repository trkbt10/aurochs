...
import { TWIPS_PER_POINT, PT_TO_PX } from "../domain/ecma376-defaults";
 ...
 */
function convertTableWidth(width: TableWidth | undefined, containerWidth: Pixels): Pixels | undefined {
  if (width === undefined) {
    return undefined;
  }
 ...
 */
function convertVerticalAlign(vAlign: "top" | "center" | "bottom" | "both" | undefined): "top" | "center" | "bottom" {
  switch (vAlign) {
    case "center":
      return "center";
    case "bottom":
 ...
 */
function convertHeightRule(hRule: "auto" | "atLeast" | "exact" | undefined): "auto" | "atLeast" | "exact" {
  switch (hRule) {
    case "exact":
      return "exact";
    case "atLeast":
