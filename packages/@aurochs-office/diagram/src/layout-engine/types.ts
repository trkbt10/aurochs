 ...
 */
// eslint-disable-next-line custom/max-params -- Ported helper; keeping signature avoids noisy churn.
...
export function mergeBounds(...bounds: LayoutBounds[]): LayoutBounds {
  ...
  // eslint-disable-next-line no-restricted-syntax -- Accumulated across node positions
  let minX = Infinity;
  // eslint-disable-next-line no-restricted-syntax -- Accumulated across node positions
  let minY = Infinity;
  // eslint-disable-next-line no-restricted-syntax -- Accumulated across node positions
