...
import { getIntAttr, parseColor } from "@aurochs-office/drawing-ml/parser";
import type { Color } from "@aurochs-office/drawing-ml/domain/color";

/**
 * Parse diagram colors definition from XML document.
 */
export function parseDiagramColorsDefinition(doc: XmlDocument): DiagramColorsDefinition | undefined {
...
export function parseDiagramColorsDefinitionHeader(doc: XmlDocument): DiagramColorsDefinitionHeader | undefined {
...
function parseColorsDefinitionHeader(element: XmlElement): DiagramColorsDefinitionHeader | undefined {
