...
export function parseDiagramStyleDefinitionHeader(doc: XmlDocument): DiagramStyleDefinitionHeader | undefined {
...
export function parseDiagramStyleDefinitionHeaderList(doc: XmlDocument): DiagramStyleDefinitionHeaderList | undefined {
...
function parseStyleDefinitionHeader(element: XmlElement): DiagramStyleDefinitionHeader | undefined {
