...
import { getIntAttr, parseBoolean, parseFloat64, parseInt32 } from "@aurochs-office/drawing-ml/parser";
...
export function parseDiagramLayoutDefinitionHeader(doc: XmlDocument): DiagramLayoutDefinitionHeader | undefined {
...
function parseLayoutDefinitionHeader(element: XmlElement): DiagramLayoutDefinitionHeader | undefined {
...
function parseHorizontalAlignment(value: string | undefined): DiagramHorizontalAlignment | undefined {
...
function parseNodeHorizontalAlignment(value: string | undefined): DiagramNodeHorizontalAlignment | undefined {
  return isNodeHorizontalAlignment(value) ? value : undefined;
}

function isNodeHorizontalAlignment(value: string | undefined): value is DiagramNodeHorizontalAlignment {
  switch (value) {
    case "ctr":
    case "l":
    case "r":
...
function parseNodeVerticalAlignment(value: string | undefined): DiagramNodeVerticalAlignment | undefined {
  return isNodeVerticalAlignment(value) ? value : undefined;
}

function isNodeVerticalAlignment(value: string | undefined): value is DiagramNodeVerticalAlignment {
  switch (value) {
    case "b":
    case "mid":
    case "t":
...
function parseDiagramTextAlignment(value: string | undefined): DiagramTextAlignment | undefined {
...
function parseFallbackDimension(value: string | undefined): DiagramFallbackDimension | undefined {
...
function parseFunctionArgument(value: string | undefined): DiagramFunctionArgument | undefined {
...
function parseFunctionOperator(value: string | undefined): DiagramFunctionOperator | undefined {
...
function parseHierarchyAlignment(value: string | undefined): DiagramHierarchyAlignment | undefined {
...
function parseConstraintRelationship(value: string | undefined): DiagramConstraintRelationship | undefined {
  return isConstraintRelationship(value) ? value : undefined;
}

function isConstraintRelationship(value: string | undefined): value is DiagramConstraintRelationship {
  switch (value) {
    case "ch":
    case "des":
    case "self":
...
function parsePyramidAccentPosition(value: string | undefined): DiagramPyramidAccentPosition | undefined {
  return isPyramidAccentPosition(value) ? value : undefined;
}

function isPyramidAccentPosition(value: string | undefined): value is DiagramPyramidAccentPosition {
  switch (value) {
    case "aft":
    case "bef":
      return true;
...
function parsePyramidAccentTextMargin(value: string | undefined): DiagramPyramidAccentTextMargin | undefined {
  return isPyramidAccentTextMargin(value) ? value : undefined;
}

function isPyramidAccentTextMargin(value: string | undefined): value is DiagramPyramidAccentTextMargin {
  switch (value) {
    case "stack":
    case "step":
      return true;
...
function parseSecondaryChildAlignment(value: string | undefined): DiagramSecondaryChildAlignment | undefined {
  return isSecondaryChildAlignment(value) ? value : undefined;
}

function isSecondaryChildAlignment(value: string | undefined): value is DiagramSecondaryChildAlignment {
  switch (value) {
    case "b":
    case "l":
    case "none":
...
function parseSecondaryLinearDirection(value: string | undefined): DiagramSecondaryLinearDirection | undefined {
  return isSecondaryLinearDirection(value) ? value : undefined;
}

function isSecondaryLinearDirection(value: string | undefined): value is DiagramSecondaryLinearDirection {
  switch (value) {
    case "fromB":
    case "fromL":
    case "fromR":
...
function parseTextAnchorHorizontal(value: string | undefined): DiagramTextAnchorHorizontal | undefined {
  return isTextAnchorHorizontal(value) ? value : undefined;
}

function isTextAnchorHorizontal(value: string | undefined): value is DiagramTextAnchorHorizontal {
  switch (value) {
    case "ctr":
    case "none":
      return true;
...
function parseTextAnchorVertical(value: string | undefined): DiagramTextAnchorVertical | undefined {
  return isTextAnchorVertical(value) ? value : undefined;
}

function isTextAnchorVertical(value: string | undefined): value is DiagramTextAnchorVertical {
  switch (value) {
    case "b":
    case "mid":
    case "t":
...
function parseTextBlockDirection(value: string | undefined): DiagramTextBlockDirection | undefined {
  return isTextBlockDirection(value) ? value : undefined;
}

function isTextBlockDirection(value: string | undefined): value is DiagramTextBlockDirection {
  switch (value) {
    case "horz":
    case "vert":
      return true;
...
function parseChooseList(elements: readonly XmlElement[]): readonly DiagramChoose[] | undefined {
  if (elements.length === 0) return undefined;
  const choose = elements.map(parseChoose).filter((value): value is DiagramChoose => value !== undefined);
...
function getAttrFromChild(parent: XmlElement, childName: string, attrName: string): string | undefined {
