...
describe("parsePane", () => {
  ...
  it("should parse pane attributes", () => {
    const el = parseElement('<pane xSplit="2" ySplit="3" topLeftCell="C4" activePane="bottomRight" state="frozen" />');
...
describe("parseSelection", () => {
  ...
  it("should parse selection attributes", () => {
    const el = parseElement('<selection pane="bottomRight" activeCell="D5" sqref="D5:E10" />');
...
describe("parseSheetView", () => {
  it("should parse sheet view attributes", () => {
    const el = parseElement('<sheetView tabSelected="1" showGridLines="0" showRowColHeaders="1" zoomScale="100" />');
