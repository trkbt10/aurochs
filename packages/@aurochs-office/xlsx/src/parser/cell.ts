...
import { getAttr, getChild, getTextContent } from "@aurochs/xml";
 ...
 */
export function parseCellWithAddress(cellElement: XmlElement, context: XlsxParseContext, address: CellAddress): Cell {
 ...
 * @see ECMA-376 Part 4, Section 18.3.1.4 (c - Cell)
 */
export function parseCell(cellElement: XmlElement, context: XlsxParseContext): Cell {
