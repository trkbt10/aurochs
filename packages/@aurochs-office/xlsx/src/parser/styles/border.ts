...
import type { XlsxBorder, XlsxBorderEdge, XlsxBorderStyle } from "../../domain/style/border";
 ...
 * ```
 */
export function parseBorderEdge(edgeElement: XmlElement | undefined): XlsxBorderEdge | undefined {
  if (!edgeElement) {
    return undefined;
  }
