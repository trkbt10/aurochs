...
import type { XlsxBorder, XlsxBorderStyle } from "@aurochs-office/xlsx/domain/style/border";
    ...
    default:
      try {
        ...
        warnOrThrow(
          ctx,
          {
            code: "BORDER_STYLE_UNSUPPORTED",
            where: "XF.border",
            message: `Unsupported XLS border style; using none: 0x${v.toString(16)}`,
            meta: { style: v },
          },
...
export function convertXlsBorderStylesToXlsxBorder(
  border: XlsXfBorderStyles,
