...
import type { EMU } from "@aurochs-office/drawing-ml/domain/units";
import type { AlignH, AlignV, PositionH, PositionV, Point2D } from "../domain/drawing/position";
import type { WrapPolygon, WrapSquare, WrapThrough, WrapTight, WrapTopAndBottom } from "../domain/drawing/wrap";
 ...
 */
export function parseEffectExtentElement(element: XmlElement | undefined): DrawingEffectExtent | undefined {
  if (!element) {
    return undefined;
  }
...
export function parsePositionHElement(element: XmlElement | undefined): PositionH | undefined {
  ...
  if (align === undefined && offset === undefined) {
    return undefined;
  }
 ...
 */
export function parseWrapPolygonElement(element: XmlElement | undefined): WrapPolygon | undefined {
  if (!element) {
    return undefined;
  }
  ...
  const lineTos = getChildren(element, "wp:lineTo").map((child) => parsePoint2DElement(child));
  if (lineTos.some((pt) => !pt)) {
    return undefined;
  }
 ...
 */
export function parseWrapSquareElement(element: XmlElement | undefined): WrapSquare | undefined {
  if (!element) {
    return undefined;
  }
 ...
 */
export function parseWrapThroughElement(element: XmlElement | undefined): WrapThrough | undefined {
  if (!element) {
    return undefined;
  }
  const wrapText = parseWrapText(element.attrs.wrapText);
 ...
 */
export function parseWrapTopAndBottomElement(element: XmlElement | undefined): WrapTopAndBottom | undefined {
  if (!element) {
    return undefined;
  }
  const distT = parseWrapDistance(element.attrs.distT);
...
function parseGraphicFrameLocksElement(element: XmlElement | undefined): GraphicFrameLocks | undefined {
  if (!element) {
    return undefined;
  }
 ...
 */
export function parseCNvFrPrElement(element: XmlElement | undefined): GraphicFrameLocks | undefined {
  if (!element) {
    return undefined;
  }
 ...
 */
export function parseCxnSpLocksElement(element: XmlElement | undefined): ConnectorLocks | undefined {
  if (!element) {
    return undefined;
  }
 ...
 */
export function parseLinkedTxbxElement(element: XmlElement | undefined): LinkedTextbox | undefined {
  if (!element) {
    return undefined;
  }
 ...
 */
export function parseWspElement(element: XmlElement | undefined): { normalEastAsianFlow?: boolean } | undefined {
  if (!element) {
    return undefined;
  }
  const normalEastAsianFlow = parseBoolean(element.attrs.normalEastAsianFlow);
  if (normalEastAsianFlow === undefined) {
    return undefined;
  }
