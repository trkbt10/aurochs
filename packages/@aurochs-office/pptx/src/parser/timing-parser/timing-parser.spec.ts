...
describe("parseTiming - ECMA-376 compliance", () => {
  describe("p:timing element (ECMA-376 19.5.87)", () => {
    ...
    it("parses timing with root parallel time node", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", dur: "indefinite", nodeType: "tmRoot" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses timing with build list", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1" })])]),
        el("p:bldLst", {}, [el("p:bldP", { spid: "3", grpId: "0", build: "p" })]),
      ]);
      const result = parseTiming(timing);
...
describe("Time Node Parsing - ECMA-376 compliance", () => {
    ...
    it("parses parallel time node with children", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "2", dur: "1000" })])]),
            ]),
          ]),
        ]),
      ]);
      ...
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:seq", { concurrent: "1", nextAc: "seek" }, [el("p:cTn", { id: "2", nodeType: "mainSeq" })]),
              ]),
            ]),
          ]),
        ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:seq", {}, [
                  el("p:cTn", { id: "2" }),
                  el("p:nextCondLst", {}, [
                    el("p:cond", { evt: "onNext", delay: "0" }, [el("p:tgtEl", {}, [el("p:sldTgt")])]),
                  ]),
                ]),
              ]),
            ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:seq", {}, [
                  el("p:cTn", { id: "2" }),
                  el("p:prevCondLst", {}, [
                    el("p:cond", { evt: "onPrev", delay: "0" }, [el("p:tgtEl", {}, [el("p:sldTgt")])]),
                  ]),
                ]),
              ]),
            ]),
        ...
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:subTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })])]),
                ]),
              ]),
            ]),
          ]),
  ...
  describe("p:cTn (common time node) (ECMA-376 19.5.33)", () => {
    it("parses duration in milliseconds", () => {
      const timing = el("p:timing", {}, [el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", dur: "500" })])])]);
      const result = parseTiming(timing);
    ...
    it("parses indefinite duration", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", dur: "indefinite" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses fill behavior", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", fill: "hold" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses restart behavior", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", restart: "never" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses time node type", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", nodeType: "withGroup" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses sync behavior", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", syncBehavior: "locked" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses master relation", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", masterRel: "lastClick" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses preset info", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [el("p:cTn", { id: "1", presetID: "1", presetClass: "entr", presetSubtype: "0" })]),
        ]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses acceleration and deceleration (0-100000)", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", accel: "50000", decel: "25000" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses autoReverse", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", autoRev: "1" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses repeatCount", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1", repeatCount: "3000" })])]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses iterate interval with tmAbs", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:iterate", { type: "lt", backwards: "1" }, [el("p:tmAbs", { val: "10000" })]),
            ]),
          ]),
        ]),
      ]);
    ...
    it("parses iterate interval with tmPct", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [el("p:iterate", { type: "wd" }, [el("p:tmPct", { val: "10%" })])]),
          ]),
        ]),
      ]);
      const result = parseTiming(timing);
              ...
              el("p:childTnLst", {}, [
                el("p:anim", { calcmode: "lin", valueType: "num" }, [
                  el("p:cBhvr", { additive: "base", accumulate: "always", override: "childStyle", xfrmType: "pt" }, [
                    ...
                    el("p:attrNameLst", {}, [el("p:attrName", {}, ["style.opacity"])]),
                  ]),
                ]),
              ]),
            ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  ...
                  el("p:to", {}, [el("p:strVal", { val: "visible" })]),
                ]),
              ]),
            ]),
          ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:animEffect", { transition: "in" }, [
                  el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })])]),
                  el("p:progress", {}, [el("p:fltVal", { val: "0.5" })]),
                ]),
              ]),
            ]),
          ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:anim", {}, [
                  el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })])]),
                  el("p:tavLst", {}, [
                    el("p:tav", { tm: "0" }, [el("p:val", {}, [el("p:strVal", { val: "start" })])]),
                    el("p:tav", { tm: "100000" }, [el("p:val", {}, [el("p:strVal", { val: "end" })])]),
                  ]),
                ]),
              ]),
            ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:anim", {}, [
                  el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })])]),
                  el("p:tavLst", {}, [
                    el("p:tav", { tm: "0" }, [el("p:val", {}, [el("p:fltVal", { val: "0.0" })])]),
                    el("p:tav", { tm: "50000" }, [el("p:val", {}, [el("p:fltVal", { val: "0.5" })])]),
                    el("p:tav", { tm: "100000" }, [el("p:val", {}, [el("p:fltVal", { val: "1.0" })])]),
                  ]),
                ]),
              ]),
            ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:anim", {}, [
                  ...
                  el("p:tavLst", {}, [
                    el("p:tav", { tm: "0" }, [
                      el("p:val", {}, [el("p:clrVal", {}, [el("a:srgbClr", { val: "FF0000" })])]),
                    ]),
                  ]),
                ]),
              ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:anim", {}, [
                  el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })])]),
                  el("p:tavLst", {}, [
                    el("p:tav", { tm: "0", fmla: "#ppt_x" }, [el("p:val", {}, [el("p:strVal", { val: "0" })])]),
                  ]),
                ]),
              ]),
            ]),
      ...
      el("p:tnLst", {}, [
        el("p:par", {}, [
          el("p:cTn", { id: "1" }, [
            el("p:childTnLst", {}, [
              el("p:anim", { calcmode: "lin", valueType: "num" }, [
                el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "5" })])]),
                el("p:tavLst", {}, [
              ...
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [
                      el("p:spTgt", { spid: "5" }, [el("p:txEl", {}, [el("p:pRg", { st: "0", end: "2" })])]),
                    ]),
                  ]),
                ]),
              ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [el("p:spTgt", { spid: "5" }, [el("p:subSp", { spid: "_x0000_s70664" })])]),
                  ]),
                ]),
              ]),
            ]),
              ...
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [
                      el("p:spTgt", { spid: "5" }, [el("p:txEl", {}, [el("p:charRg", { st: "5", end: "10" })])]),
                    ]),
                  ]),
                ]),
              ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [el("p:spTgt", { spid: "5" }, [el("p:bg")])]),
                  ]),
                ]),
              ]),
            ]),
              ...
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    ...
                    el("p:tgtEl", {}, [
                      el("p:spTgt", { spid: "5" }, [
                        el("p:graphicEl", {}, [el("a:dgm", { id: "{87C2C707-C3F4-4E81-A967-A8B8AE13E575}" })]),
                      ]),
                    ]),
                  ]),
                ]),
              ...
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [
                      el("p:spTgt", { spid: "5" }, [el("p:oleChartEl", { type: "gridLegend", lvl: "1" })]),
                    ]),
                  ]),
                ]),
              ]),
      ...
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:set", {}, [el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:sldTgt")])])]),
              ]),
            ]),
          ]),
        ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:set", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [el("p:sndTgt", { "r:embed": "rId1", name: "click.wav" })]),
                  ]),
                ]),
              ]),
            ]),
            ...
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:animEffect", {}, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2" }),
                    el("p:tgtEl", {}, [el("p:inkTgt", { spid: "_x0000_s2057" })]),
                  ]),
                ]),
              ]),
            ]),
...
describe("Condition Parsing - ECMA-376 compliance", () => {
  describe("p:cond (condition) (ECMA-376 19.5.25)", () => {
    it("parses start condition with delay", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [el("p:cTn", { id: "1" }, [el("p:stCondLst", {}, [el("p:cond", { delay: "500" })])])]),
        ]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses indefinite delay", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [el("p:cTn", { id: "1" }, [el("p:stCondLst", {}, [el("p:cond", { delay: "indefinite" })])])]),
        ]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses condition with event", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [el("p:stCondLst", {}, [el("p:cond", { evt: "onClick", delay: "0" })])]),
          ]),
        ]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses end condition", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [el("p:cTn", { id: "1" }, [el("p:endCondLst", {}, [el("p:cond", { evt: "onEnd" })])])]),
        ]),
      ]);
      const result = parseTiming(timing);
    ...
    it("parses endSync condition with runtime node", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [el("p:endSync", { evt: "end", delay: "0" }, [el("p:rtn", { val: "all" })])]),
          ]),
        ]),
      ]);
      const result = parseTiming(timing);
...
describe("Build List Parsing - ECMA-376 compliance", () => {
  describe("p:bldP (build paragraph) (ECMA-376 19.5.12)", () => {
      ...
      const timing = el("p:timing", {}, [
        ...
        el("p:bldLst", {}, [
          el("p:bldP", { spid: "5", build: "p" }, [
            el("p:tmplLst", {}, [
              el("p:tmpl", { lvl: "1" }, [el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "10" })])])]),
            ]),
          ]),
        ]),
      ]);
    ...
    it("parses build graphic with bldAsOne", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1" })])]),
        el("p:bldLst", {}, [el("p:bldGraphic", { spid: "4", grpId: "0", uiExpand: "1" }, [el("p:bldAsOne")])]),
      ]);
      const result = parseTiming(timing);
      const entry = result?.buildList?.[0];
    ...
    it("parses build embedded chart", () => {
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "1" })])]),
        el("p:bldLst", {}, [el("p:bldOleChart", { spid: "1025", grpId: "0", bld: "series", animBg: "0" })]),
      ]);
      const result = parseTiming(timing);
      const entry = result?.buildList?.[0];
          ...
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:excl", {}, [
                  el("p:cTn", { id: "2", dur: "1000" }, [
                    el("p:childTnLst", {}, [el("p:par", {}, [el("p:cTn", { id: "3" })])]),
                  ]),
                ]),
              ]),
            ]),
      ...
      const timing = el("p:timing", {}, [
        el("p:tnLst", {}, [
          el("p:par", {}, [
            el("p:cTn", { id: "1" }, [
              el("p:childTnLst", {}, [
                el("p:animRot", { from: "0", to: "5400000" }, [
                  // 0 to 90 degrees
                  el("p:cBhvr", {}, [el("p:cTn", { id: "2" }), el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })])]),
                ]),
              ]),
              ...
              el("p:childTnLst", {}, [
                el("p:animClr", { clrSpc: "rgb", dir: "cw" }, [
                  el("p:cBhvr", {}, [
                    el("p:cTn", { id: "2", dur: "1000" }),
                    el("p:tgtEl", {}, [el("p:spTgt", { spid: "3" })]),
                    el("p:attrNameLst", {}, [el("p:attrName", {}, ["fillcolor"])]),
                  ]),
                  el("p:to", {}, [el("a:srgbClr", { val: "FF0000" })]),
                ]),
              ]),
            ]),
          ]),
              ...
              el("p:childTnLst", {}, [
                el("p:audio", { isNarration: "1" }, [
                  el("p:cMediaNode", {}, [
                    ...
                    el("p:tgtEl", {}, [el("p:sndTgt", { "r:embed": "rId1", name: "audio.mp3" })]),
                  ]),
                ]),
              ]),
            ]),
