...
import type { AnimationTarget, ShapeTarget, TextElementTarget, GraphicElementTarget } from "../../domain/animation";
...
function parseOleChartElement(oleChartEl: XmlElement): {
  type?: ReturnType<typeof mapChartSubelementType>;
  level?: number;
} {
