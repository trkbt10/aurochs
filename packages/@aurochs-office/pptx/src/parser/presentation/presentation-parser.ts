...
import type { EmbeddedFont, EmbeddedFontReference, EmbeddedFontTypeface } from "../../domain/embedded-font";
...
export function parsePresentation(element: XmlElement): Presentation {
  ...
  return {
    ...
    removePersonalInfoOnSave: parseBooleanAttr(attrs["removePersonalInfoOnSave"], DEFAULT_REMOVE_PERSONAL_INFO_ON_SAVE),
    compatMode: parseBooleanAttr(attrs["compatMode"], DEFAULT_COMPAT_MODE),
    strictFirstAndLastChars: parseBooleanAttr(attrs["strictFirstAndLastChars"], DEFAULT_STRICT_FIRST_AND_LAST_CHARS),
    ...
    autoCompressPictures: parseBooleanAttr(attrs["autoCompressPictures"], DEFAULT_AUTO_COMPRESS_PICTURES),
