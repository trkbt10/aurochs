...
import { getAttr, getChild, getChildren, type XmlElement } from "@aurochs/xml";
 ...
 */
export function processAlternateContent(mcElement: XmlElement, childName: string): XmlElement | undefined {
