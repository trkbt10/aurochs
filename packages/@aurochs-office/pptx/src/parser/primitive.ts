...
export function parseCoordinateUnqualified(value: string | undefined): Pixels | undefined {
  ...
  if (num < -27273042329600 || num > 27273042316900) {
    return undefined;
  }
 ...
 */
export function getChildAttr(parent: XmlElement, childName: string, attrName: string): string | undefined {
 ...
 */
export function getChildEmuAttr(parent: XmlElement, childName: string, attrName: string): Pixels | undefined {
 ...
 */
export function getChildBoolAttr(parent: XmlElement, childName: string, attrName: string): boolean | undefined {
