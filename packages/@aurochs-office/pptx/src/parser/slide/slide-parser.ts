 ...
 */
export function parseSlide(content: XmlDocument | undefined, context?: ParseContext): Slide | undefined {
  if (!content) {
    return undefined;
  }
 ...
 */
export function parseSlideLayout(content: XmlDocument | undefined, _context?: ParseContext): SlideLayout | undefined {
  void _context;
  if (!content) {
    return undefined;
  }
 ...
 */
export function parseNotesMaster(content: XmlDocument | undefined, _context?: ParseContext): NotesMaster | undefined {
  void _context;
  if (!content) {
    return undefined;
  }
