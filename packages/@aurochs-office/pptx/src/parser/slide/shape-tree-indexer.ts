...
import { getChild, getChildren, isXmlElement } from "@aurochs/xml";
...
function indexShapeTreeNode(node: XmlElement, tables: IndexTables): void {
  ...
  // eslint-disable-next-line no-restricted-syntax -- mutable: checked across multiple fallback element names
