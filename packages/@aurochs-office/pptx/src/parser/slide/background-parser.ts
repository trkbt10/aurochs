...
import type { BackgroundFill, GradientData } from "../../domain/slide/background";
...
// =============================================================================
// BackgroundFill → ResolvedBackgroundFill conversion
// =============================================================================
 ...
 */
function calculateRadialCenter(gradientData: GradientData): { cx: number; cy: number } | undefined {
