...
import { getAttr, getChild, getChildren, getTextContent, isXmlElement, type XmlElement } from "@aurochs/xml";
...
}: ResolveUnderlineColorOptions): ReturnType<typeof parseColorFromParent> | undefined {
  if (underlineColor) {
 ...
 */
export function parseTextBody(txBody: XmlElement | undefined, ctx?: TextStyleContext): TextBody | undefined {
  if (!txBody) {
    return undefined;
  }
