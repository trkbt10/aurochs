...
describe("parseBodyProperties", () => {
  ...
  describe("vertical overflow (ECMA-376 21.1.2.1.42)", () => {
    it('parses vertOverflow="overflow"', () => {
      const bodyPr = xml(
        '<a:bodyPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" vertOverflow="overflow"/>',
      );
      const result = parseBodyProperties(bodyPr);
    ...
    it('parses vertOverflow="ellipsis"', () => {
      const bodyPr = xml(
        '<a:bodyPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" vertOverflow="ellipsis"/>',
      );
      const result = parseBodyProperties(bodyPr);
  ...
  describe("additional body properties (ECMA-376 21.1.2.1.2)", () => {
    ...
    it("parses spcFirstLastPara attribute", () => {
      const bodyPr = xml(
        '<a:bodyPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" spcFirstLastPara="1"/>',
      );
      const result = parseBodyProperties(bodyPr);
...
describe("parseRunProperties", () => {
  ...
  describe("bold and italic", () => {
    ...
    it("handles on/off/def values", () => {
      expect(
        parseRunProperties(xml('<a:rPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" b="on"/>'))
          ?.bold,
      ).toBe(true);
      expect(
        parseRunProperties(xml('<a:rPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" b="off"/>'))
          ?.bold,
      ).toBe(false);
      expect(
        parseRunProperties(xml('<a:rPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" b="def"/>'))
          ?.bold,
      ).toBeUndefined();
    });
  });
