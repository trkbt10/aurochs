 ...
 */
export function getFontSizeFromLstStyle(lstStyle: XmlElement | undefined, lvl: number): Points | undefined {
 ...
 */
function getFontSizeFromPlaceholder(placeholder: XmlElement | undefined, lvl: number): Points | undefined {
