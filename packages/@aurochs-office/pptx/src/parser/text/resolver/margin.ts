 ...
 */
function getMarginFromPPr(pPr: XmlElement | undefined, attrName: "marL" | "marR" | "indent"): Pixels | undefined {
  if (pPr === undefined) {
    return undefined;
  }
  if (attrName === "indent") {
...
function getMarginFromMasterTextStyles({
  ...
  lvl,
  attrName,
}: GetMarginFromMasterTextStylesOptions): Pixels | undefined {
 ...
 */
function resolveMargin({ directPPr, localLstStyle, lvl, ctx, attrName }: ResolveMarginOptions): Pixels | undefined {
 ...
 */
export function resolveMarginLeft({ directPPr, localLstStyle, lvl, ctx }: MarginResolutionContext): Pixels | undefined {
...
export function resolveMarginRight({
  ...
  lvl,
  ctx,
}: MarginResolutionContext): Pixels | undefined {
 ...
 */
export function resolveIndent({ directPPr, localLstStyle, lvl, ctx }: MarginResolutionContext): Pixels | undefined {
