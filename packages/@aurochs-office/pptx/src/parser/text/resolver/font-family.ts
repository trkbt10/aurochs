 ...
 */
function getFontFamilyFromLstStyle(lstStyle: XmlElement | undefined, lvl: number): FontFamilyResult | undefined {
 ...
 */
function getFontFamilyFromPlaceholder(placeholder: XmlElement | undefined, lvl: number): FontFamilyResult | undefined {
...
function getFontFamilyFromMasterTextStyles(
  ...
  const rp = level?.defaultRunProperties;
  if (rp === undefined) {
    return undefined;
  }

  // Return undefined if no font family is specified
  if (
    rp.fontFamily === undefined &&
    rp.fontFamilyEastAsian === undefined &&
    rp.fontFamilyComplexScript === undefined &&
    rp.fontFamilySymbol === undefined
  ) {
    return undefined;
  }
  ...
  return {
    latin: rp.fontFamily,
    eastAsian: rp.fontFamilyEastAsian,
    complexScript: rp.fontFamilyComplexScript,
    symbol: rp.fontFamilySymbol,
  };
}
...
export function resolveFontFamily(
  ...
  const masterStyleFont = getFontFamilyFromMasterTextStyles(ctx.masterTextStyles, ctx.placeholderType, lvlKey);
