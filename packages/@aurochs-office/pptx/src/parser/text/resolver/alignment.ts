 ...
 */
function getAlignmentFromLstStyle(lstStyle: XmlElement | undefined, lvl: number): TextAlignment | undefined {
 ...
 */
function getAlignmentFromPlaceholder(placeholder: XmlElement | undefined, lvl: number): TextAlignment | undefined {
