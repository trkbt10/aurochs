 ...
 */
function getBulletPropertiesFromLstStyle(lstStyle: XmlElement | undefined, lvl: number): BulletProperties | undefined {
 ...
 */
function mergeBulletProperties(...sources: (BulletProperties | undefined)[]): BulletProperties {
  const result: Partial<BulletProperties> = {};
  ...
  for (const source of sources) {
    ...
    if (
      ...
      result.autoNumType === undefined &&
      result.blipResourceId === undefined
    ) {
...
export function resolveBulletStyle(
  ...
  if (
    merged.none === undefined &&
    merged.char === undefined &&
    merged.autoNumType === undefined &&
    merged.blipResourceId === undefined
  ) {
    return undefined;
  }
