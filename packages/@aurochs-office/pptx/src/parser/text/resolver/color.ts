 ...
 */
function getColorFromLstStyle(lstStyle: XmlElement | undefined, lvl: number): Color | undefined {
 ...
 */
function getColorFromPlaceholder(placeholder: XmlElement | undefined, lvl: number): Color | undefined {
