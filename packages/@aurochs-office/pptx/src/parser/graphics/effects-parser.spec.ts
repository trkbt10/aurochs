...
describe("parseEffects - a:alphaModFix (ECMA-376 Section 20.1.8.6)", () => {
  it("parses alpha modulate fixed amount", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:alphaModFix", { amt: "25000" })])]);
  ...
  it("defaults to 100% when amount is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:alphaModFix", {})])]);
...
describe("parseEffects - a:alphaOutset (ECMA-376 Section 20.1.8.7)", () => {
  it("parses alpha outset radius", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:alphaOutset", { rad: "19050" })])]);
  ...
  it("returns undefined when radius is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:alphaOutset", {})])]);
...
describe("parseEffects - a:alphaRepl (ECMA-376 Section 20.1.8.8)", () => {
  it("parses alpha replace value", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:alphaRepl", { a: "75000" })])]);
  ...
  it("returns undefined when alpha is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:alphaRepl", {})])]);
...
describe("parseEffects - a:biLevel (ECMA-376 Section 20.1.8.11)", () => {
  it("parses bi-level threshold", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:biLevel", { thresh: "30000" })])]);
  ...
  it("returns undefined when threshold is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:biLevel", {})])]);
...
describe("parseEffects - a:blend (ECMA-376 Section 20.1.8.12)", () => {
  it("parses blend effect attributes", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [
        el("a:blend", { blend: "screen" }, [el("a:cont", { type: "sib", name: "blendContainer" })]),
      ]),
    ]);
  ...
  it("returns undefined when blend attribute is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:blend", {}, [el("a:cont", {})])])]);
  ...
  it("returns undefined when container is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:blend", { blend: "over" })])]);
...
describe("parseEffects - a:clrChange (ECMA-376 Section 20.1.8.16)", () => {
  ...
  it("returns undefined when colors are missing", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [el("a:clrChange", {}, [el("a:clrFrom", {}, [el("a:srgbClr", { val: "000000" })])])]),
    ]);
...
describe("parseEffects - a:clrRepl (ECMA-376 Section 20.1.8.18)", () => {
  it("parses color replace value", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:clrRepl", {}, [el("a:srgbClr", { val: "FF00FF" })])])]);
  ...
  it("returns undefined when color is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:clrRepl", {})])]);
...
describe("parseEffects - a:duotone (ECMA-376 Section 20.1.8.23)", () => {
  it("parses duotone colors", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [
        el("a:duotone", {}, [el("a:srgbClr", { val: "112233" }), el("a:srgbClr", { val: "AABBCC" })]),
      ]),
    ]);
  ...
  it("returns undefined when fewer than two colors are provided", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:duotone", {}, [el("a:srgbClr", { val: "112233" })])])]);
...
describe("parseEffects - a:fillOverlay (ECMA-376 Section 20.1.8.29)", () => {
  it("parses fill overlay blend and fill type", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [
        el("a:fillOverlay", { blend: "darken" }, [el("a:solidFill", {}, [el("a:srgbClr", { val: "000000" })])]),
      ]),
    ]);
  ...
  it("returns undefined when blend is missing", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [el("a:fillOverlay", {}, [el("a:solidFill", {}, [el("a:srgbClr", { val: "000000" })])])]),
    ]);
  ...
  it("returns undefined when fill is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:fillOverlay", { blend: "over" })])]);
...
describe("parseEffects - a:grayscl (ECMA-376 Section 20.1.8.34)", () => {
  it("parses gray scale effect", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:grayscl", {})])]);
...
describe("parseEffects - a:prstShdw (ECMA-376 Section 20.1.8.49)", () => {
  it("parses preset shadow attributes", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [
        el("a:prstShdw", { prst: "shdw5", dist: "19050", dir: "5400000" }, [el("a:srgbClr", { val: "112233" })]),
      ]),
    ]);
  ...
  it("returns undefined when preset or color is missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:prstShdw", { dist: "19050" })])]);
...
describe("parseEffects - a:relOff (ECMA-376 Section 20.1.8.51)", () => {
  it("parses relative offset percentages", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:relOff", { tx: "50000", ty: "25000" })])]);
  ...
  it("returns undefined when offsets are missing", () => {
    const spPr = el("p:spPr", {}, [el("a:effectLst", {}, [el("a:relOff", {})])]);
...
describe("parseEffects - containerKind for round-trip fidelity", () => {
  it("records containerKind as 'effectLst' when parsing effectLst", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [el("a:outerShdw", { blurRad: "38100" }, [el("a:srgbClr", { val: "000000" })])]),
    ]);
    const result = parseEffects(spPr);
  ...
  it("records containerKind as 'effectLst' when both effectLst and effectDag present", () => {
    const spPr = el("p:spPr", {}, [
      el("a:effectLst", {}, [el("a:outerShdw", { blurRad: "38100" }, [el("a:srgbClr", { val: "FF0000" })])]),
      el("a:effectDag", {}, [el("a:outerShdw", { blurRad: "38100" }, [el("a:srgbClr", { val: "0000FF" })])]),
    ]);
    const result = parseEffects(spPr);
