 ...
 */
function resolveEffectiveSchemeColor(schmClrName: string, colorCtx: ColorResolveContext): string {
 ...
 */
export function findColorElement(node: XmlElement): { key: ColorElementKey; element: XmlElement } | undefined {
