 ...
 */
function getPresetConnectionSites(preset: string, width: number, height: number): readonly ResolvedConnectionSite[] {
 ...
 */
function resolveCoordinate(value: Pixels | number | string, context: GuideContext): number {
