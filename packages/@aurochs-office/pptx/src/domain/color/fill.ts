 ...
 */
export function resolveColorWithAlpha(color: Color, colorContext?: ColorContext): ResolvedColor | undefined {
...
function resolveRadialCenter(fill: {
  readonly path?: { readonly fillToRect?: { left: number; right: number; top: number; bottom: number } };
