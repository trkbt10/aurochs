 ...
 *
 * Wraps @aurochs/glyph line breaking functions with OOXML-specific types (Pixels, Points).
 * Provides type-safe line breaking for PPTX and DOCX text layout.
 *
 * @see @aurochs/glyph/breaking - Core line breaking functions (plain numbers)
 */
...
import type { BreakableSpan as GlyphBreakableSpan } from "@aurochs/glyph";
...
/**
 * Convert MeasuredSpan to plain number span for @aurochs/glyph.
 */
