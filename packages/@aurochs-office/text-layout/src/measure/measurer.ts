 ...
 *
 * Wraps @aurochs/glyph measurement functions with OOXML-specific types (Pixels, Points).
 * Provides type-safe text measurement for PPTX and DOCX text layout.
 *
 * @see @aurochs/glyph/measure - Core measurement functions (plain numbers)
 */
 ...
 */
export function calculateCharWidth(args: {
 ...
 */
export function measureTextWidth(args: {
 ...
 */
export function estimateTextWidth(args: {
  readonly text: string;
  readonly fontSize: Points;
  readonly letterSpacing: Pixels;
  readonly fontFamily: string;
...
function findCharIndexAtOffset(args: {
 ...
 */
export function measureTextDetailed(args: {
  readonly text: string;
  readonly fontSize: Points;
  readonly letterSpacing: Pixels;
  readonly fontFamily: string;
