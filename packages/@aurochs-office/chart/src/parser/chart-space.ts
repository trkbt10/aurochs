...
import { getChild, getChildren, getAttr as xmlGetAttr, getXmlText, type XmlElement } from "@aurochs/xml";
import { deg } from "@aurochs-office/drawing-ml/domain/units";
import { getBoolAttr, getIntAttr, parseBoolean, parseFloat64, parseInt32 } from "@aurochs-office/drawing-ml/parser";
